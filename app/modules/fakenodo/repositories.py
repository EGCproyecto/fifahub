...
class FakenodoRepository:
    ...
    def add_csv_file(self, deposition_id: int, file_name: str, file_path: str) -> dict:
        ...
        logger.info(
            f"FakenodoRepository: Added CSV file '{file_name}' to deposition ID {deposition_id}"
        )
        return meta_data
    ...
    def delete_deposition(self, deposition_id: int) -> bool:
        ...
        logger.warning(
            f"FakenodoRepository: Tried to delete non-existent deposition ID {deposition_id}"
        )
        return False
