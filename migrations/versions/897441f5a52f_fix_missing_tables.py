...
Revision ID: 897441f5a52f
Revises: b5d4a1f22a57
Create Date: 2025-11-28 11:41:27.150855
...
def upgrade():
    ...
    op.create_index(
        op.f("ix_user_two_factor_recovery_code_user_id"), "user_two_factor_recovery_code", ["user_id"], unique=False
    )
    op.create_table(
        "author",
        sa.Column("id", sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_index(op.f("ix_user_two_factor_recovery_code_user_id"), table_name="user_two_factor_recovery_code")
