...
class Index(IndexBase):
    ...
    def as_composable_template(
        ...
        return ComposableIndexTemplate(template_name, pattern or self._name, index=self, priority=priority)
    ...
    def clone(self, name: Optional[str] = None, using: Optional[UsingType] = None) -> Self:
        """
    ...
    def create(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def save(self, using: Optional[UsingType] = None) -> "Optional[ObjectApiResponse[Any]]":
        """
    ...
    def analyze(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def refresh(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def flush(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def get(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def open(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def close(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def delete(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def exists(self, using: Optional[UsingType] = None, **kwargs: Any) -> bool:
        ...
        """
        return bool(self._get_connection(using).indices.exists(index=self._name, **kwargs))

    def put_mapping(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def get_mapping(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def get_field_mapping(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def put_alias(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def exists_alias(self, using: Optional[UsingType] = None, **kwargs: Any) -> bool:
        ...
        """
        return bool(self._get_connection(using).indices.exists_alias(index=self._name, **kwargs))

    def get_alias(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def delete_alias(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def get_settings(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def put_settings(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def stats(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def segments(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def validate_query(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def clear_cache(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def recovery(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def shard_stores(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def forcemerge(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    def shrink(self, using: Optional[UsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
