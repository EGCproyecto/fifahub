...
class IndexMeta(DocumentMeta):
    ...
    def __new__(cls, name: str, bases: Tuple[type, ...], attrs: Dict[str, Any]) -> "IndexMeta":
...
class Document(DocumentBase, metaclass=IndexMeta):
    ...
    @classmethod
    def init(cls, index: Optional[str] = None, using: Optional[UsingType] = None) -> None:
        """
    ...
    @classmethod
    def search(cls, using: Optional[UsingType] = None, index: Optional[str] = None) -> Search[Self]:
        """
    ...
    def update(
        ...
        **fields: Any,
        ...
        meta = self._get_connection(using).update(index=i, body=body, refresh=refresh, **doc_meta)
        ...
        **kwargs: Any,
        ...
        class Generate:
            ...
            def __next__(self) -> Dict[str, Any]:
                doc: Optional[Union[Document, Dict[str, Any]]] = self.doc_iterator.__next__()
