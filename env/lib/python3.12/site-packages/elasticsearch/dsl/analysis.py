...
class CustomAnalysisDefinition(CustomAnalysis):
    ...
    def get_analysis_definition(self) -> Dict[str, Any]:
        ...
        char_filters = {f._name: f.get_definition() for f in self.char_filter if hasattr(f, "get_definition")}
        if char_filters:
...
class CustomAnalyzer(CustomAnalysisDefinition, Analyzer):
    ...
    def _get_body(self, text: str, explain: bool, attributes: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def get_analysis_definition(self) -> Dict[str, Any]:
        ...
        for filters in self.filters:
            if isinstance(filters, str):
                continue
            fs.update({f._name: f.get_definition() for f in filters if hasattr(f, "get_definition")})
        return d
...
class ConditionalTokenFilter(CustomTokenFilter):
    ...
    def get_analysis_definition(self) -> Dict[str, Any]:
        ...
        return {"filter": {f._name: f.get_definition() for f in self.filter if hasattr(f, "get_definition")}}
