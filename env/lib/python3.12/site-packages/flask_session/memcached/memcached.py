...
class MemcachedSessionInterface(ServerSideSessionInterface):
    ...
    def __init__(
        ...
        if client is None or not all(hasattr(client, method) for method in ["get", "set", "delete"]):
            warnings.warn(
        ...
        self.client = client
        super().__init__(app, key_prefix, use_signer, permanent, sid_length, serialization_format)
