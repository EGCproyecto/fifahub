...
class Connection:
        ...
        while True:
            ...
            if packet_number != self._next_seq_id:
                ...
                raise err.InternalError(
                    "Packet sequence number wrong - got %d expected %d" % (packet_number, self._next_seq_id)
                )
            self._next_seq_id = (self._next_seq_id + 1) % 256
    ...
    def _write_bytes(self, data):
        ...
        try:
            ...
            self._force_close()
            raise err.OperationalError(CR.CR_SERVER_GONE_ERROR, f"MySQL server has gone away ({e!r})")
