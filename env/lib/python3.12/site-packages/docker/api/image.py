...
class ImageApiMixin:
    ...
    def import_image(self, src=None, repository=None, tag=None, image=None, changes=None, stream_src=False):
        ...
        params = _import_image_params(
            repository, tag, image, src=(src if isinstance(src, str) else None), changes=changes
        )
    ...
    def load_image(self, data, quiet=None):
        ...
        if quiet is not None:
            if utils.version_lt(self._version, "1.23"):
                raise errors.InvalidVersion("quiet is not supported in API version < 1.23")
            params["quiet"] = quiet

        res = self._post(self._url("/images/load"), data=data, params=params, stream=True)
    ...
    def pull(self, repository, tag=None, stream=False, auth_config=None, decode=False, platform=None, all_tags=False):
        """
