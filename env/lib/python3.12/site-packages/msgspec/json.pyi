...
class Encoder:
    ...
    def encode_into(self, obj: Any, buffer: bytearray, offset: Optional[int] = 0, /) -> None: ...
...
def encode(
    obj: Any, /, *, enc_hook: enc_hook_sig = None, order: Literal[None, "deterministic", "sorted"] = None
) -> bytes: ...
def schema(type: Any, *, schema_hook: schema_hook_sig = None) -> Dict[str, Any]: ...
def schema_components(
    types: Iterable[Any], *, schema_hook: schema_hook_sig = None, ref_template: str = "#/$defs/{name}"
