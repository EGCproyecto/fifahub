...
def test_TSP_alternate_weight():
    ...
    assert nx_app.traveling_salesman_problem(G, weight="weight") == nx_app.traveling_salesman_problem(
        H, weight="distance"
    )
...
def test_asadpour_tsp():
    ...
    tour = nx_app.traveling_salesman_problem(G, weight="weight", method=nx_app.asadpour_atsp, seed=19)
...
def test_asadpour_real_world():
    ...
    tour = nx_app.traveling_salesman_problem(G, weight="weight", method=nx_app.asadpour_atsp, seed=37, source="JFK")
...
def test_asadpour_real_world_path():
    ...
    path = nx_app.traveling_salesman_problem(G, weight="weight", cycle=False, method=nx_app.asadpour_atsp, seed=56)
