...
class TestDFS:
    ...
    def test_dfs_edges_sorting(self):
        ...
        edges_desc = nx.dfs_edges(G, source=0, sort_neighbors=lambda x: sorted(x, reverse=True))
    ...
    def test_dfs_labeled_edges_sorting(self):
        ...
        edges_desc = nx.dfs_labeled_edges(G, source=0, sort_neighbors=lambda x: sorted(x, reverse=True))
