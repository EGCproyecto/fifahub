...
@pytest.mark.parametrize("fn", (nx.is_matching, nx.is_maximal_matching, nx.is_perfect_matching))
...
@pytest.mark.parametrize("fn", (nx.max_weight_matching, nx.min_weight_matching, nx.maximal_matching))
...
class TestMaxWeightMatching:
    ...
    def test_negative_weights(self):
        ...
        assert edges_equal(nx.max_weight_matching(G, maxcardinality=True), {(1, 3), (2, 4)})
        assert edges_equal(nx.min_weight_matching(G), {(1, 2), (3, 4)})
