...
def test_directed_bugs():
    ...
    Tree1_hash = nx.weisfeiler_lehman_graph_hash(Tree1, node_attr="weight")  # Default is 3 iterations
...
def test_trivial_labels_hashes():
    ...
    for i in range(1, r + 1):
        ...
        assert first == second
        third = nx.weisfeiler_lehman_graph_hash(G1, edge_attr="e_weight", node_attr="weight")
        assert second == third
