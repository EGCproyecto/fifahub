...
def generate_plugin(args):  # type: ignore
    ...
    os.rename(os.path.join(dst, "flamapy/metamodels/__NAME__"), os.path.join(dst, f"flamapy/metamodels/{name}"))
    ...
    for name, docstring, method, parameters in dynamic_commands:
        ...
        if "configuration_path" in [param.name for param in parameters]:
            subparser.add_argument(
                "--configuration_path", type=str, help="Path to the configuration file", required=False
            )
