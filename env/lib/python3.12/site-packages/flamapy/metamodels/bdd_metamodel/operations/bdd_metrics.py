...
class BDDMetrics(Metrics):
    ...
    def calculate_metamodel_metrics(self, model: VariabilityModel) -> list[dict[str, Any]]:
        ...
        self._configurations_number = bdd_operations.BDDConfigurationsNumber().execute(self.model).get_result()
    ...
    def total_variability(self) -> dict[str, Any]:
        ...
        return self.construct_result(name=name, doc=self.total_variability.__doc__, result=_total_variability)
    ...
    def partial_variability(self) -> dict[str, Any]:
        ...
        return self.construct_result(name=name, doc=self.partial_variability.__doc__, result=_partial_variability)
    ...
    def configurations(self) -> dict[str, Any]:
        ...
        _configurations = [feature for config in _configurations for feature in config.get_selected_elements()]
        return self.construct_result(
            name=name, doc=self.configurations.__doc__, result=_configurations, size=len(_configurations)
        )
    ...
    def configurations_number(self) -> dict[str, Any]:
        ...
        return self.construct_result(name=name, doc=self.configurations_number.__doc__, result=_configurations_number)
    ...
    def descriptive_statistics(self) -> dict[str, Any]:
        ...
        return self.construct_result(name=name, doc=self.descriptive_statistics.__doc__, result=_desc_stats)
    ...
    def feature_inclusion_probabilities(self) -> dict[str, Any]:
        ...
        _prob = self._fip
        return self.construct_result(name=name, doc=self.feature_inclusion_probabilities.__doc__, result=_prob)
