...
def configurations(bdd_model: BDDModel, partial_config: Optional[Configuration] = None) -> list[Configuration]:
    ...
    for assignment in bdd_model.bdd.pick_iter(u_func, care_vars=care_vars):
        features = {bdd_model.variables_features[f]: True for f in assignment.keys() if assignment[f]}
