...
from flamapy.metamodels.fm_metamodel.models import FeatureModel, Range, Domain, Attribute
...
class GenerateRandomAttribute(Operation):
    ...
    def execute(self, model: VariabilityModel) -> "GenerateRandomAttribute":
        ...
        self.result = generate_random_attribute_values(
            fm_model, self._attribute_name, self._attribute_domain, self._only_leaf_features
        )
        return self


def generate_random_attribute_values(
    feature_model: FeatureModel, name: str, domain: Domain, only_leaf_features: bool
) -> FeatureModel:
