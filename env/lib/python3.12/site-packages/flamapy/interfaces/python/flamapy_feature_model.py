...
class FLAMAFeatureModel:
    ...
    def atomic_sets(self) -> Union[None, List[List[Any]]]:
        ...
        try:
            atomic_sets = self.discover_metamodel.use_operation(self.fm_model, "FMAtomicSets").get_result()
            result = []
    ...
    def average_branching_factor(self) -> Union[None, float]:
        ...
        # Try to use the Find operation, which returns the atomic sets if they are found
        try:
            result = self.discover_metamodel.use_operation(self.fm_model, "FMAverageBranchingFactor").get_result()
            return result
        except FlamaException as exception:
            print(f"Error: {exception}")
            return None
    ...
    def count_leafs(self) -> Union[None, int]:
        ...
        # Try to use the Find operation, which returns the atomic sets if they are found
        try:
            result = self.discover_metamodel.use_operation(self.fm_model, "FMCountLeafs").get_result()
            return result
        except FlamaException as exception:
            print(f"Error: {exception}")
            return None
    ...
    def leaf_features(self) -> Union[None, List[str]]:
        ...
        try:
            features = self.discover_metamodel.use_operation(self.fm_model, "FMLeafFeatures").get_result()
            leaf_features = []
    ...
    def max_depth(self) -> Union[None, int]:
        ...
        try:
            return self.discover_metamodel.use_operation(self.fm_model, "FMMaxDepthTree").get_result()
        except FlamaException as exception:
            print(f"Error: {exception}")
            return None
    ...
    def core_features(self) -> Union[None, List[str]]:
        ...
        try:
            ...
            features = self.discover_metamodel.use_operation(self.sat_model, "PySATCoreFeatures").get_result()
            return features
        except FlamaException as exception:
            print(f"Error: {exception}")
            return None
    ...
    def dead_features(self) -> Union[None, List[str]]:
        ...
        try:
            self._transform_to_sat()
            features = self.discover_metamodel.use_operation(self.sat_model, "PySATDeadFeatures").get_result()
            return features
        except FlamaException as exception:
            print(f"Error: {exception}")
            return None
    ...
    def false_optional_features(self) -> Union[None, List[str]]:
        ...
        try:
            self._transform_to_sat()
            operation = self.discover_metamodel.get_operation(self.sat_model, "PySATFalseOptionalFeatures")
    ...
    def filter(self, configuration_path: str) -> Union[None, List[Configuration]]:
        ...
        try:
            self._transform_to_sat()
            configuration = self.discover_metamodel.use_transformation_t2m(configuration_path, "configuration")
    ...
    def configurations_number(self, with_sat: bool = False) -> Union[None, int]:
        ...
        try:
            ...
            if with_sat:
                self._transform_to_sat()
                nop = self.discover_metamodel.use_operation(self.sat_model, "PySATConfigurationsNumber").get_result()
            else:
                self._transform_to_bdd()
                nop = self.discover_metamodel.use_operation(self.bdd_model, "BDDConfigurationsNumber").get_result()
            return nop
        except FlamaException as exception:
            print(f"Error: {exception}")
            return None
    ...
    def configurations(self, with_sat: bool = False) -> Union[None, List[Configuration]]:
        ...
        try:
            ...
            if with_sat:
                self._transform_to_sat()
                products = self.discover_metamodel.use_operation(self.sat_model, "PySATConfigurations").get_result()
            else:
                self._transform_to_bdd()
                products = self.discover_metamodel.use_operation(self.bdd_model, "BDDConfigurations").get_result()
            return products
        except FlamaException as exception:
            print(f"Error: {exception}")
            return None
    ...
    def satisfiable_configuration(self, configuration_path: str, full_configuration: bool = False) -> Union[None, bool]:
        """
        ...
        try:
            self._transform_to_sat()
            configuration = self.discover_metamodel.use_transformation_t2m(configuration_path, "configuration")
            operation = self.discover_metamodel.get_operation(self.sat_model, "PySATSatisfiableConfiguration")
    ...
    def satisfiable(self) -> Union[None, bool]:
        ...
        try:
            self._transform_to_sat()
            result = self.discover_metamodel.use_operation(self.sat_model, "PySATSatisfiable").get_result()
            return result
        except FlamaException as exception:
            print(f"Error: {exception}")
            return None
