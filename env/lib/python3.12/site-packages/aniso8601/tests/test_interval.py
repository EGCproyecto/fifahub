...
class TestIntervalParser_UtilityFunctions(unittest.TestCase):
    def test_get_interval_resolution(self):
        self.assertEqual(
            _get_interval_resolution(
                IntervalTuple(
                    start=DateTuple(YYYY="2001", MM="02", DD="03", Www=None, D=None, DDD=None),
                    end=DatetimeTuple(
        ...
        self.assertEqual(
            _get_interval_resolution(
                IntervalTuple(
                    ...
                    end=DateTuple(YYYY="2001", MM="02", DD="03", Www=None, D=None, DDD=None),
                    duration=None,
                )
            ),
            IntervalResolution.Seconds,
        ...
        self.assertEqual(
            _get_interval_resolution(
                IntervalTuple(
                    ...
                    duration=DurationTuple(PnY="1", PnM="2", PnW=None, PnD="3", TnH="4", TnM="5", TnS="6"),
                )
            ),
            IntervalResolution.Seconds,
        )
    ...
    def test_get_interval_component_resolution(self):
        self.assertEqual(
            _get_interval_component_resolution(DateTuple(YYYY="2001", MM=None, DD=None, Www=None, D=None, DDD="123")),
            IntervalResolution.Ordinal,
        )
        self.assertEqual(
            _get_interval_component_resolution(DateTuple(YYYY="2001", MM=None, DD=None, Www="12", D="3", DDD=None)),
            IntervalResolution.Weekday,
        )
        self.assertEqual(
            _get_interval_component_resolution(DateTuple(YYYY="2001", MM=None, DD=None, Www="12", D=None, DDD=None)),
            IntervalResolution.Week,
        )
        self.assertEqual(
            _get_interval_component_resolution(DateTuple(YYYY="2001", MM="02", DD="03", Www=None, D=None, DDD=None)),
            IntervalResolution.Day,
        )
        self.assertEqual(
            _get_interval_component_resolution(DateTuple(YYYY="2001", MM="02", DD=None, Www=None, D=None, DDD=None)),
            IntervalResolution.Month,
        )
        self.assertEqual(
            _get_interval_component_resolution(DateTuple(YYYY="2001", MM=None, DD=None, Www=None, D=None, DDD=None)),
        ...
        self.assertEqual(
            _get_interval_component_resolution(
                DurationTuple(PnY="1", PnM="2", PnW=None, PnD="3", TnH="4", TnM="5", TnS="6")
            ),
            IntervalResolution.Seconds,
        )
        self.assertEqual(
            _get_interval_component_resolution(
                DurationTuple(PnY="1", PnM="2", PnW=None, PnD="3", TnH="4", TnM="5", TnS=None)
            ),
            IntervalResolution.Minutes,
        )
        self.assertEqual(
            _get_interval_component_resolution(
                DurationTuple(PnY="1", PnM="2", PnW=None, PnD="3", TnH="4", TnM=None, TnS=None)
            ),
            IntervalResolution.Hours,
        )
        self.assertEqual(
            _get_interval_component_resolution(
                DurationTuple(PnY="1", PnM="2", PnW=None, PnD="3", TnH=None, TnM=None, TnS=None)
            ),
            IntervalResolution.Day,
        )
        self.assertEqual(
            _get_interval_component_resolution(
                DurationTuple(PnY="1", PnM="2", PnW=None, PnD=None, TnH=None, TnM=None, TnS=None)
            ),
            IntervalResolution.Month,
        )
        self.assertEqual(
            _get_interval_component_resolution(
                DurationTuple(PnY="1", PnM=None, PnW=None, PnD=None, TnH=None, TnM=None, TnS=None)
            ),
            IntervalResolution.Year,
        )
        self.assertEqual(
            _get_interval_component_resolution(
                DurationTuple(PnY=None, PnM=None, PnW="3", PnD=None, TnH=None, TnM=None, TnS=None)
            ),
            IntervalResolution.Week,
        )
...
class TestIntervalParserFunctions(unittest.TestCase):
    def test_get_interval_resolution_date(self):
        ...
        self.assertEqual(get_interval_resolution("P1.5Y/2018-03"), IntervalResolution.Month)
        self.assertEqual(get_interval_resolution("P1.5Y/2018-03-06"), IntervalResolution.Day)
        self.assertEqual(get_interval_resolution("P1.5Y/2018W01"), IntervalResolution.Week)
        self.assertEqual(get_interval_resolution("P1.5Y/2018-306"), IntervalResolution.Ordinal)
        self.assertEqual(get_interval_resolution("P1.5Y/2018W012"), IntervalResolution.Weekday)

        self.assertEqual(get_interval_resolution("2018/P1.5Y"), IntervalResolution.Year)
        self.assertEqual(get_interval_resolution("2018-03/P1.5Y"), IntervalResolution.Month)
        self.assertEqual(get_interval_resolution("2018-03-06/P1.5Y"), IntervalResolution.Day)
        self.assertEqual(get_interval_resolution("2018W01/P1.5Y"), IntervalResolution.Week)
        self.assertEqual(get_interval_resolution("2018-306/P1.5Y"), IntervalResolution.Ordinal)
        self.assertEqual(get_interval_resolution("2018W012/P1.5Y"), IntervalResolution.Weekday)

    def test_get_interval_resolution_time(self):
        self.assertEqual(get_interval_resolution("P1M/1981-04-05T01"), IntervalResolution.Hours)
        self.assertEqual(get_interval_resolution("P1M/1981-04-05T01:01"), IntervalResolution.Minutes)
        self.assertEqual(
            get_interval_resolution("P1M/1981-04-05T01:01:00"),
            IntervalResolution.Seconds,
        )

        self.assertEqual(get_interval_resolution("1981-04-05T01/P1M"), IntervalResolution.Hours)
        self.assertEqual(get_interval_resolution("1981-04-05T01:01/P1M"), IntervalResolution.Minutes)
        self.assertEqual(
    ...
    def test_get_interval_resolution_duration(self):
        self.assertEqual(get_interval_resolution("2014-11-12/P1Y2M3D"), IntervalResolution.Day)
        self.assertEqual(get_interval_resolution("2014-11-12/P1Y2M"), IntervalResolution.Day)
        self.assertEqual(get_interval_resolution("2014-11-12/P1Y"), IntervalResolution.Day)
        self.assertEqual(get_interval_resolution("2014-11-12/P1W"), IntervalResolution.Day)
        self.assertEqual(get_interval_resolution("2014-11-12/P1Y2M3DT4H"), IntervalResolution.Hours)
        self.assertEqual(
        ...
        self.assertEqual(get_interval_resolution("P1Y2M3D/2014-11-12"), IntervalResolution.Day)
        self.assertEqual(get_interval_resolution("P1Y2M/2014-11-12"), IntervalResolution.Day)
        self.assertEqual(get_interval_resolution("P1Y/2014-11-12"), IntervalResolution.Day)
        self.assertEqual(get_interval_resolution("P1W/2014-11-12"), IntervalResolution.Day)
        self.assertEqual(get_interval_resolution("P1Y2M3DT4H/2014-11-12"), IntervalResolution.Hours)
        self.assertEqual(
    ...
    def test_parse_interval(self):
        testtuples = (
            ...
            (
                ...
                {
                    "end": DateTuple("2018", "03", "06", None, None, None),
                    "duration": DurationTuple(None, None, None, None, None, None, "0.0000001"),
                },
            ),
            (
                ...
                {
                    "end": DateTuple("2018", "03", "06", None, None, None),
                    "duration": DurationTuple(None, None, None, None, None, None, "2.0000048"),
                },
            ),
            (
            ...
            (
                "2018-03-06/P2,5M",
                {
                    ...
                    "duration": DurationTuple(None, "2.5", None, None, None, None, None),
                },
            ),
            (
                "2018-03-06/P2.5M",
    ...
    def test_parse_interval_end(self):
        self.assertEqual(
            _parse_interval_end("02", DateTuple("2020", "01", "01", None, None, None), "T"),
            DateTuple(None, None, "02", None, None, None),
        )

        self.assertEqual(
            _parse_interval_end("03-14", DateTuple("2008", "02", "15", None, None, None), "T"),
            DateTuple(None, "03", "14", None, None, None),
        )

        self.assertEqual(
            _parse_interval_end("0314", DateTuple("2008", "02", "15", None, None, None), "T"),
            DateTuple(None, "03", "14", None, None, None),
        )
