...
class TestBaseTimeBuilder(unittest.TestCase):
    ...
    def test_build_object(self):
        ...
        datetimetest = (
            DatetimeTuple(
                DateTuple("1", "2", "3", "4", "5", "6"),
                TimeTuple("7", "8", "9", TimezoneTuple(True, False, "10", "11", "tz name")),
            ),
            (
                DateTuple("1", "2", "3", "4", "5", "6"),
                TimeTuple("7", "8", "9", TimezoneTuple(True, False, "10", "11", "tz name")),
        ...
        intervaltests = (
            ...
            (
                IntervalTuple(
                    None,
                    TimeTuple("1", "2", "3", TimezoneTuple(True, False, "4", "5", "tz name")),
                    DurationTuple("6", "7", "8", "9", "10", "11", "12"),
                ),
                {
                    "start": None,
                    "end": TimeTuple("1", "2", "3", TimezoneTuple(True, False, "4", "5", "tz name")),
    ...
    def test_combine_concise_interval_tuples(self):
        testtuples = (
            ...
            (
                DatetimeTuple(
                    DateTuple("2007", "11", "13", None, None, None),
                    TimeTuple("09", "00", None, TimezoneTuple(False, True, None, None, "Z")),
                ),
                DatetimeTuple(
                    DateTuple(None, None, "15", None, None, None),
                    TimeTuple("17", "00", None, None),
                ...
                DatetimeTuple(
                    DateTuple("2007", "11", "15", None, None, None),
                    TimeTuple("17", "00", None, TimezoneTuple(False, True, None, None, "Z")),
                ),
            ),
        )
...
class TestTupleBuilder(unittest.TestCase):
    ...
    def test_build_datetime(self):
        testtuples = (
            ...
            (
                {
                    "date": DateTuple("1", "2", "3", "4", "5", "6"),
                    "time": TimeTuple("7", "8", "9", TimezoneTuple(True, False, "10", "11", "tz name")),
                },
                DatetimeTuple(
                    DateTuple("1", "2", "3", "4", "5", "6"),
                    TimeTuple("7", "8", "9", TimezoneTuple(True, False, "10", "11", "tz name")),
    ...
    def test_build_interval(self):
        testtuples = (
            ...
            (
                {
                    "start": TimeTuple("1", "2", "3", TimezoneTuple(True, False, "7", "8", "tz name")),
                    "end": TimeTuple("4", "5", "6", TimezoneTuple(False, False, "9", "10", "tz name")),
                },
                IntervalTuple(
                    TimeTuple("1", "2", "3", TimezoneTuple(True, False, "7", "8", "tz name")),
                    TimeTuple("4", "5", "6", TimezoneTuple(False, False, "9", "10", "tz name")),
                    None,
                ),
            ),
            (
