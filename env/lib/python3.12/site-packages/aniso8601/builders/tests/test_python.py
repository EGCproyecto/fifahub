...
class TestPythonTimeBuilder(unittest.TestCase):
    ...
    def test_build_time(self):
        testtuples = (
            ...
            (
                ...
                datetime.time(hour=1, minute=23, tzinfo=UTCOffset(name="+1", minutes=60)),
            ),
            (
                {
                    "hh": "1",
    ...
    def test_build_datetime(self):
        testtuples = (
            (
                ...
                datetime.datetime(2019, 6, 5, hour=1, minute=3, second=11, microsecond=858714),
            ),
            (
                (
                ...
                datetime.datetime(1234, 2, 3, hour=23, minute=21, second=28, microsecond=512400),
            ),
            (
                (
    ...
    def test_build_duration(self):
        testtuples = (
            ...
            (
                ...
                datetime.timedelta(hours=4, minutes=54, seconds=28, microseconds=512400),
            ),
            # Make sure we truncate, not round
            # https://bitbucket.org/nielsenb/aniso8601/issues/10/sub-microsecond-precision-in-durations-is
            # https://bitbucket.org/nielsenb/aniso8601/issues/21/sub-microsecond-precision-is-lost-when
            ...
            (
                ...
                datetime.timedelta(days=59, hours=23, minutes=59, seconds=59, microseconds=999999),
            ),
            (
                {"PnW": "1.9999999999999999"},
                datetime.timedelta(days=13, hours=23, minutes=59, seconds=59, microseconds=999999),
            ),
            (
                {"PnD": "1.9999999999999999"},
                datetime.timedelta(days=1, hours=23, minutes=59, seconds=59, microseconds=999999),
            ),
            (
                {"TnH": "14.9999999999999999"},
                datetime.timedelta(hours=14, minutes=59, seconds=59, microseconds=999999),
            ),
            ...
            (
                ...
                datetime.timedelta(days=428, hours=14, minutes=43, seconds=59, microseconds=999999),
            ),
            # Verify overflows
    ...
    def test_build_interval(self):
        testtuples = (
            ...
            (
                {
                    ...
                    "duration": DurationTuple("1999.9999999999999999", None, None, None, None, None, None),
                },
                datetime.date(year=2000, month=1, day=1),
                datetime.datetime(year=1, month=4, day=30, hour=0, minute=0, second=0, microsecond=1),
            ),
            (
                {
                    "end": DateTuple("1989", "03", "01", None, None, None),
                    "duration": DurationTuple(None, "1.9999999999999999", None, None, None, None, None),
                },
            ...
            (
                {
                    "end": DateTuple("1989", "03", "01", None, None, None),
                    "duration": DurationTuple(None, None, "1.9999999999999999", None, None, None, None),
                },
                datetime.date(year=1989, month=3, day=1),
                datetime.datetime(
                    year=1989,
            ...
            (
                {
                    "end": DateTuple("1989", "03", "01", None, None, None),
                    "duration": DurationTuple(None, None, None, "1.9999999999999999", None, None, None),
                },
                datetime.date(year=1989, month=3, day=1),
                datetime.datetime(
                    year=1989,
            ...
            (
                {
                    ...
                    "duration": DurationTuple(None, None, None, None, "14.9999999999999999", None, None),
                },
            ...
            (
                {
                    "end": DateTuple("2001", "01", "01", None, None, None),
                    "duration": DurationTuple(None, None, None, None, None, "0.00000000999", None),
                },
                datetime.date(year=2001, month=1, day=1),
            ...
            (
                {
                    "end": DateTuple("2001", "01", "01", None, None, None),
                    "duration": DurationTuple(None, None, None, None, None, "0.0000000999", None),
                },
                datetime.date(year=2001, month=1, day=1),
                datetime.datetime(
                    year=2000,
            ...
            (
                ...
                datetime.date(year=2001, month=1, day=1),
                datetime.datetime(year=2001, month=1, day=1, hour=0, minute=0, second=0, microsecond=5),
            ),
            (
                {
                    "start": DateTuple("2018", "03", "06", None, None, None),
            ...
            (
                ...
                datetime.date(year=2018, month=3, day=6),
                datetime.datetime(year=2018, month=3, day=6, hour=0, minute=0, second=2, microsecond=4),
            ),
            (
                {
                    "start": DatetimeTuple(
    ...
    def test_range_check_interval(self):
        with self.assertRaises(YearOutOfBoundsError):
            PythonTimeBuilder.build_interval(
                ...
                duration=DurationTuple(None, None, None, str(datetime.timedelta.max.days), None, None, None),
            )
    ...
    def test_date_generator(self):
        ...
        for dateindex in compat.range(0, 10):
            self.assertEqual(
                results[dateindex],
                datetime.date(year=2018, month=8, day=29) + dateindex * datetime.timedelta(days=1),
            )
    ...
    def test_date_generator_unbounded(self):
        ...
        for dateindex in compat.range(0, 10):
            self.assertEqual(
                next(generator),
                datetime.date(year=2018, month=8, day=29) + dateindex * datetime.timedelta(days=5),
            )
