        ...
        def __del__(self):
            if self._watcher:
                ...
                if tb is not None:
                    tb_msg = "\n".join(tb.format())
                    tb_msg = "\nTraceback:\n" + tb_msg
                warnings.warn("Failed to close watcher %r%s" % (self, tb_msg), ResourceWarning)
...
class IoMixin(object):
    ...
    def __init__(self, loop, fd, events, ref=True, priority=None, _args=None):
        ...
        self._fd = fd
        super(IoMixin, self).__init__(loop, ref=ref, priority=priority, args=_args or (fd, events))
...
class StatMixin(object):
    ...
    def __init__(self, _loop, path, interval=0.0, ref=True, priority=None):
        ...
        super(StatMixin, self).__init__(_loop, ref=ref, priority=priority, args=(self._cpath, interval))
