...
class TestPopen(greentest.TestCase):
    ...
    def test_communicate_undecodable(self):
        ...
        with subprocess.Popen(
            [sys.executable, "-W", "ignore", "-c", "import os, sys; " r'os.write(sys.stdout.fileno(), b"\xff")'],
            stdin=subprocess.PIPE,
            stdout=subprocess.PIPE,
            stderr=subprocess.PIPE,
            text=True,
    ...
    def test_popen_bufsize(self):
        ...
        with subprocess.Popen(
            [sys.executable, "-u", "-c", "import sys; sys.stdout.write(sys.stdin.readline())"],
            stdin=subprocess.PIPE,
            stdout=subprocess.PIPE,
        ) as p:
...
class RunFuncTestCase(greentest.TestCase):
    ...
    def test_check_output_input_arg(self):
        ...
        cp = self.run_python(
            "import sys; sys.stdout.write(sys.stdin.read().upper())", input=b"pear", stdout=subprocess.PIPE
        )
        self.assertIn(b"PEAR", cp.stdout)
