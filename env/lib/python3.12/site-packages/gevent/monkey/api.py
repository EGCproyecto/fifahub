    ...
    * ``_gevent_did_monkey_patch(target_module, items, warn, **kwargs)``
    ...
    try:
        ...
        if _notify_will_subscribers:
            _notify_patch(
                events.GeventWillPatchModuleEvent(target_module.__name__, source_module, target_module, items),
                _warnings,
            )
    ...
    do_patch = getattr(source_module, "_gevent_do_monkey_patch", _GeventDoPatchRequest.default_patch_items)
    ...
    if _notify_did_subscribers:
        ...
        _notify_patch(events.GeventDidPatchModuleEvent(target_module.__name__, source_module, target_module))
