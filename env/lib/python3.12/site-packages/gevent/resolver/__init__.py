...
class AbstractResolver(object):
    ...
    EAI_NONAME_MSG = "nodename nor servname provided, or not known" if MAC else "Name or service not known"
    ...
    _KNOWN_SOCKTYPES = {
        v for k, v in vars(_socket).items() if k.startswith("SOCK_") and k not in ("SOCK_CLOEXEC", "SOCK_MAX_SIZE")
    }
    ...
    def _gethostbyname_ex(self, hostname_bytes, family):
        ...
        addresses = []
        tuples = self.getaddrinfo(hostname_bytes, 0, family, SOCK_STREAM, SOL_TCP, AI_CANONNAME)
