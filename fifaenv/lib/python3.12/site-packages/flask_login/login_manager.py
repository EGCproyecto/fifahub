...
from flask import abort, current_app, flash, g, has_app_context, redirect, request, session
...
class LoginManager:
    ...
    def header_loader(self, callback):
        ...
        warnings.warn(
            "'header_loader' is deprecated and will be removed in" " Flask-Login 0.7. Use 'request_loader' instead.",
            DeprecationWarning,
            stacklevel=2,
        )
