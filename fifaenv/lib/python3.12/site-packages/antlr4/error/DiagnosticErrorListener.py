...
class DiagnosticErrorListener(ErrorListener):
    ...
    def reportAttemptingFullContext(
        self, recognizer: Parser, dfa: DFA, startIndex: int, stopIndex: int, conflictingAlts: set, configs: ATNConfigSet
    ):
        with StringIO() as buf:
    ...
    def reportContextSensitivity(
        self, recognizer: Parser, dfa: DFA, startIndex: int, stopIndex: int, prediction: int, configs: ATNConfigSet
    ):
        with StringIO() as buf:
