...
from antlr4.error.Errors import RecognitionException, UnsupportedOperationException
...
from antlr4.tree.Tree import ErrorNode, ParseTreeListener, TerminalNode
...
class TraceListener(ParseTreeListener):
    ...
    def enterEveryRule(self, ctx):
        print(
            "enter   " + self._parser.ruleNames[ctx.getRuleIndex()] + ", LT(1)=" + self._parser._input.LT(1).text,
    ...
    def visitTerminal(self, node):
        ...
        print(
            "consume " + str(node.symbol) + " rule " + self._parser.ruleNames[self._parser._ctx.getRuleIndex()],
            file=self._parser._output,
        )
    ...
    def exitEveryRule(self, ctx):
        print(
            "exit    " + self._parser.ruleNames[ctx.getRuleIndex()] + ", LT(1)=" + self._parser._input.LT(1).text,
            file=self._parser._output,
        )
