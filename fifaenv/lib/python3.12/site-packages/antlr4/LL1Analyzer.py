...
from antlr4.atn.Transition import AbstractPredicateTransition, NotSetTransition, RuleTransition, WildcardTransition
from antlr4.IntervalSet import IntervalSet
from antlr4.PredictionContext import PredictionContext, PredictionContextFromRuleContext, SingletonPredictionContext
...
class LL1Analyzer(object):
    ...
    def getDecisionLookahead(self, s: ATNState):
        ...
        for alt in range(0, count):
            ...
            self._LOOK(
                s.transition(alt).target, None, PredictionContext.EMPTY, look[alt], lookBusy, set(), seeThruPreds, False
            )
