...
from antlr4.PredictionContext import PredictionContext, PredictionContextCache, SingletonPredictionContext
...
class LexerATNSimulator(ATNSimulator):
    ...
    def failOrAccept(self, prevAccept: SimState, input: InputStream, reach: ATNConfigSet, t: int):
        if self.prevAccept.dfaState is not None:
            ...
            self.accept(
                input, lexerActionExecutor, self.startIndex, prevAccept.index, prevAccept.line, prevAccept.column
            )
