...
class ATNDeserializer(object):
    ...
    edgeFactories = [
        ...
        lambda atn, src, trg, arg1, arg2, arg3, sets, target: RuleTransition(atn.states[arg1], arg2, arg3, target),
        lambda atn, src, trg, arg1, arg2, arg3, sets, target: PredicateTransition(target, arg1, arg2, arg3 != 0),
        lambda atn, src, trg, arg1, arg2, arg3, sets, target: (
            AtomTransition(target, Token.EOF) if arg3 != 0 else AtomTransition(target, arg1)
        ),
        lambda atn, src, trg, arg1, arg2, arg3, sets, target: ActionTransition(target, arg1, arg2, arg3 != 0),
        lambda atn, src, trg, arg1, arg2, arg3, sets, target: SetTransition(target, sets[arg1]),
        lambda atn, src, trg, arg1, arg2, arg3, sets, target: NotSetTransition(target, sets[arg1]),
        lambda atn, src, trg, arg1, arg2, arg3, sets, target: WildcardTransition(target),
        lambda atn, src, trg, arg1, arg2, arg3, sets, target: PrecedencePredicateTransition(target, arg1),
    ]
