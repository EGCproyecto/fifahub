...
from antlr4.error.Errors import FailedPredicateException, RecognitionException, UnsupportedOperationException
        ...
        if tt == Transition.EPSILON:
            ...
            if self.pushRecursionContextStates[p.stateNumber] and not isinstance(transition.target, LoopEndState):
                ...
                self.pushNewRecursionContext(
                    ctx, self.atn.ruleToStartState[p.ruleIndex].stateNumber, self._ctx.ruleIndex
                )
