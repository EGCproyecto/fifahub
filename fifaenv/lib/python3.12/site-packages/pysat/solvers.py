...
class Cadical103(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.cadical:
            ...
            self.status = pysolvers.cadical103_solve(self.cadical, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.cadical:
            ...
            self.status = pysolvers.cadical103_solve_lim(self.cadical, assumptions, int(MainThread.check()))
...
class Cadical153(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.cadical:
            ...
            self.status = pysolvers.cadical153_solve(self.cadical, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.cadical:
            ...
            self.status = pysolvers.cadical153_solve_lim(self.cadical, assumptions, int(MainThread.check()))
    ...
    def process(
        ...
        if self.cadical:
            return pysolvers.cadical153_process(
                self.cadical,
                rounds,
                int(block),
                int(cover),
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.cadical:
            ...
            st, props = pysolvers.cadical153_propagate(self.cadical, assumptions, phase_saving, int(MainThread.check()))
...
class Gluecard3(object):
    ...
    def new(self, bootstrap_with=None, use_timer=False, incr=False, with_proof=False, warm_start=False):
        """
        Actual constructor of the solver.
        """
    ...
    def solve(self, assumptions=[]):
        ...
        if self.gluecard:
            ...
            self.status = pysolvers.gluecard3_solve(self.gluecard, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.gluecard:
            ...
            self.status = pysolvers.gluecard3_solve_lim(
                self.gluecard, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.gluecard:
            ...
            st, props = pysolvers.gluecard3_propagate(self.gluecard, assumptions, phase_saving, int(MainThread.check()))
...
class Gluecard4(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.gluecard:
            ...
            self.status = pysolvers.gluecard41_solve(self.gluecard, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.gluecard:
            ...
            self.status = pysolvers.gluecard41_solve_lim(
                self.gluecard, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.gluecard:
            ...
            st, props = pysolvers.gluecard41_propagate(
                self.gluecard, assumptions, phase_saving, int(MainThread.check())
            )
...
class Glucose3(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.glucose:
            ...
            self.status = pysolvers.glucose3_solve(self.glucose, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.glucose:
            ...
            self.status = pysolvers.glucose3_solve_lim(
                self.glucose, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.glucose:
            ...
            st, props = pysolvers.glucose3_propagate(self.glucose, assumptions, phase_saving, int(MainThread.check()))
...
class Glucose4(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.glucose:
            ...
            self.status = pysolvers.glucose41_solve(self.glucose, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.glucose:
            ...
            self.status = pysolvers.glucose41_solve_lim(
                self.glucose, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.glucose:
            ...
            st, props = pysolvers.glucose41_propagate(self.glucose, assumptions, phase_saving, int(MainThread.check()))
...
class Glucose42(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.glucose:
            ...
            self.status = pysolvers.glucose421_solve(self.glucose, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.glucose:
            ...
            self.status = pysolvers.glucose421_solve_lim(
                self.glucose, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.glucose:
            ...
            st, props = pysolvers.glucose421_propagate(self.glucose, assumptions, phase_saving, int(MainThread.check()))
...
class Lingeling(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.lingeling:
            ...
            self.status = pysolvers.lingeling_solve(self.lingeling, assumptions, int(MainThread.check()))
...
class MapleChrono(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.maplesat:
            ...
            self.status = pysolvers.maplechrono_solve(self.maplesat, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.maplesat:
            ...
            self.status = pysolvers.maplechrono_solve_lim(
                self.maplesat, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.maplesat:
            ...
            st, props = pysolvers.maplechrono_propagate(
                self.maplesat, assumptions, phase_saving, int(MainThread.check())
            )
...
class MapleCM(object):
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.maplesat:
            ...
            self.status = pysolvers.maplecm_solve_lim(
                self.maplesat, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
...
class Maplesat(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.maplesat:
            ...
            self.status = pysolvers.maplesat_solve(self.maplesat, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.maplesat:
            ...
            self.status = pysolvers.maplesat_solve_lim(
                self.maplesat, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.maplesat:
            ...
            st, props = pysolvers.maplesat_propagate(self.maplesat, assumptions, phase_saving, int(MainThread.check()))
...
class Mergesat3(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.mergesat:
            ...
            self.status = pysolvers.mergesat3_solve(self.mergesat, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.mergesat:
            ...
            self.status = pysolvers.mergesat3_solve_lim(
                self.mergesat, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.mergesat:
            ...
            st, props = pysolvers.mergesat3_propagate(self.mergesat, assumptions, phase_saving, int(MainThread.check()))
...
class Minicard(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.minicard:
            ...
            self.status = pysolvers.minicard_solve(self.minicard, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.minicard:
            ...
            self.status = pysolvers.minicard_solve_lim(
                self.minicard, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.minicard:
            ...
            st, props = pysolvers.minicard_propagate(self.minicard, assumptions, phase_saving, int(MainThread.check()))
...
class Minisat22(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.minisat:
            ...
            self.status = pysolvers.minisat22_solve(self.minisat, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.minisat:
            ...
            self.status = pysolvers.minisat22_solve_lim(
                self.minisat, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.minisat:
            ...
            st, props = pysolvers.minisat22_propagate(self.minisat, assumptions, phase_saving, int(MainThread.check()))
...
class MinisatGH(object):
    ...
    def solve(self, assumptions=[]):
        ...
        if self.minisat:
            ...
            self.status = pysolvers.minisatgh_solve(self.minisat, assumptions, int(MainThread.check()))
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.minisat:
            ...
            self.status = pysolvers.minisatgh_solve_lim(
                self.minisat, assumptions, int(MainThread.check()), int(expect_interrupt)
            )
    ...
    def propagate(self, assumptions=[], phase_saving=0):
        ...
        if self.minisat:
            ...
            st, props = pysolvers.minisatgh_propagate(self.minisat, assumptions, phase_saving, int(MainThread.check()))
...
class CryptoMinisat(object):
    ...
    def solve_limited(self, assumptions=[], expect_interrupt=False):
        ...
        if self.cryptosat:
            ...
            self.status, self.model = self.cryptosat.solve(
                assumptions, time_limit=self.time_limit, conf_limit=self.conf_limit
            )
