...
class CardEnc(object):
    ...
    @classmethod
    def atmost(cls, lits, bound=1, top_id=None, vpool=None, encoding=EncType.seqcounter):
        """
        ...
        res = pycard.encode_atmost(lits, bound, top_id, encoding, int(MainThread.check()))
    ...
    @classmethod
    def atleast(cls, lits, bound=1, top_id=None, vpool=None, encoding=EncType.seqcounter):
        """
        ...
        res = pycard.encode_atleast(lits, bound, top_id, encoding, int(MainThread.check()))
    ...
    @classmethod
    def equals(cls, lits, bound=1, top_id=None, vpool=None, encoding=EncType.seqcounter):
        """
...
class ITotalizer(object):
    ...
    def new(self, lits=[], ubound=1, top_id=None):
        ...
        # creating the object
        self.tobj, clauses, self.rhs, self.top_id = pycard.itot_new(
            self.lits, self.ubound, self.top_id, int(MainThread.check())
        )
    ...
    def increase(self, ubound=1, top_id=None):
        ...
        clauses, self.rhs, self.top_id = pycard.itot_inc(self.tobj, self.ubound, self.top_id, int(MainThread.check()))
    ...
    def extend(self, lits=[], ubound=None, top_id=None):
        ...
        # updating the object and adding more variables and clauses
        self.tobj, clauses, self.rhs, self.top_id = pycard.itot_ext(
            self.tobj, lits, self.ubound, self.top_id, int(MainThread.check())
        )
    ...
    def merge_with(self, another, ubound=None, top_id=None):
        ...
        # updating the object and adding more variables and clauses
        self.tobj, clauses, self.rhs, self.top_id = pycard.itot_mrg(
            self.tobj, another.tobj, self.ubound, self.top_id, int(MainThread.check())
        )
