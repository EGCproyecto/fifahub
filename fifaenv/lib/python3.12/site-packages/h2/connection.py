...
class H2ConnectionStateMachine:
    ...
    _transitions = {
        ...
        (ConnectionState.IDLE, ConnectionInputs.SEND_ALTERNATIVE_SERVICE): (None, ConnectionState.SERVER_OPEN),
        (ConnectionState.IDLE, ConnectionInputs.RECV_ALTERNATIVE_SERVICE): (None, ConnectionState.CLIENT_OPEN),
        ...
        (ConnectionState.CLIENT_OPEN, ConnectionInputs.SEND_PRIORITY): (None, ConnectionState.CLIENT_OPEN),
        ...
        (ConnectionState.CLIENT_OPEN, ConnectionInputs.RECV_PRIORITY): (None, ConnectionState.CLIENT_OPEN),
        (ConnectionState.CLIENT_OPEN, ConnectionInputs.RECV_ALTERNATIVE_SERVICE): (None, ConnectionState.CLIENT_OPEN),
        ...
        (ConnectionState.SERVER_OPEN, ConnectionInputs.SEND_PRIORITY): (None, ConnectionState.SERVER_OPEN),
        ...
        (ConnectionState.SERVER_OPEN, ConnectionInputs.RECV_PRIORITY): (None, ConnectionState.SERVER_OPEN),
        ...
        (ConnectionState.SERVER_OPEN, ConnectionInputs.SEND_ALTERNATIVE_SERVICE): (None, ConnectionState.SERVER_OPEN),
        (ConnectionState.SERVER_OPEN, ConnectionInputs.RECV_ALTERNATIVE_SERVICE): (None, ConnectionState.SERVER_OPEN),
        # State: closed
...
class H2Connection:
    ...
    def send_headers(
        ...
        priority_present = (
            (priority_weight is not None) or (priority_depends_on is not None) or (priority_exclusive is not None)
        )
    ...
    def send_data(
        self, stream_id: int, data: bytes | memoryview, end_stream: bool = False, pad_length: Any = None
    ) -> None:
        """
    ...
    def close_connection(
        self, error_code: ErrorCodes | int = 0, additional_data: bytes | None = None, last_stream_id: int | None = None
    ) -> None:
        """
    ...
    def prioritize(
        self, stream_id: int, weight: int | None = None, depends_on: int | None = None, exclusive: bool | None = None
    ) -> None:
        """
