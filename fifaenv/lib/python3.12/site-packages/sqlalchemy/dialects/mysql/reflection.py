...
import re
from typing import TYPE_CHECKING, Any, Callable, Dict, List, Optional, Sequence, Tuple, Union, overload
...
class MySQLTableDefinitionParser:
    ...
    def _prep_regexes(self) -> None:
        ...
        self._pr_options: List[Tuple[re.Pattern[Any], Optional[Callable[[str], str]]]] = []
...
@overload
def _pr_compile(regex: str, cleanup: Callable[[str], str]) -> Tuple[re.Pattern[Any], Callable[[str], str]]: ...
