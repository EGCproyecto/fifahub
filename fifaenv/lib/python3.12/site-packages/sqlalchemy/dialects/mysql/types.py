...
class FLOAT(_FloatType, sqltypes.FLOAT[Union[decimal.Decimal, float]]):
    ...
    def bind_processor(self, dialect: Dialect) -> Optional[_BindProcessorType[Union[decimal.Decimal, float]]]:
        return None
...
class TINYINT(_IntegerType):
    ...
    def _compare_type_affinity(self, other: TypeEngine[Any]) -> bool:
        return self._type_affinity is other._type_affinity or other._type_affinity is sqltypes.Boolean
