    ...
    def __init__(
        ...
        if index_elements is not None:
            self.inferred_target_elements = [
                coercions.expect(roles.DDLConstraintColumnRole, column) for column in index_elements
            ]
...
class OnConflictDoUpdate(OnConflictClause):
    ...
    def __init__(
        ...
        self.update_whereclause = coercions.expect(roles.WhereHavingRole, where) if where is not None else None
