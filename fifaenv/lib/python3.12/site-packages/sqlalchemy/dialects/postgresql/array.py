...
if TYPE_CHECKING:
    ...
    from ...sql.type_api import TypeEngine, _BindProcessorType, _LiteralProcessorType, _ResultProcessorType
...
class array(expression.ExpressionClauseList[_T]):
    ...
    def __init__(
        ...
        **kw: typing_Any,
        ...
        main_type = type_ if type_ is not None else self.clauses[0].type if self.clauses else sqltypes.NULLTYPE
...
class ARRAY(sqltypes.ARRAY[_T]):
    ...
    def bind_processor(self, dialect: Dialect) -> Optional[_BindProcessorType[Sequence[typing_Any]]]:
