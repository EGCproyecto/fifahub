...
class JSONPathType(sqltypes.JSON.JSONPathType):
    def _processor(self, dialect: Dialect, super_proc: Optional[Callable[[Any], Any]]) -> Callable[[Any], Any]:
...
class JSONB(JSON):
    ...
    class Comparator(JSON.Comparator[_T]):
        ...
        def delete_path(self, array: Union[List[str], _pg_array[str]]) -> ColumnElement[JSONB]:
