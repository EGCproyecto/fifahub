...
class aggregate_order_by(expression.ColumnElement[_T]):
    ...
    def __init__(
        ...
        *order_by: _ColumnExpressionArgument[Any],
        ...
        self.target: ClauseElement = coercions.expect(roles.ExpressionElementRole, target)
    ...
    def _copy_internals(self, clone: _CloneCallableType = elements._clone, **kw: Any) -> None:
