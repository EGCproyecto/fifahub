...
if TYPE_CHECKING:
    ...
    from .elements import BindParameter, ClauseList, ColumnElement, NamedColumn, SQLCoreOperations, TextClause
...
class DialectKWArgs:
    ...
    def argument_for(cls, dialect_name: str, argument_name: str, default: Any) -> None:
        ...
        construct_arg_dictionary: Optional[Dict[Any, Any]] = DialectKWArgs._kw_registry[dialect_name]
...
class Options(metaclass=_MetaOptions):
    ...
    def from_execution_options(
        ...
        if check_argnames:
            ...
            exec_options = util.immutabledict(exec_options).merge_with({key: new_options})
...
class CacheableOptions(Options, HasCacheKey):
    ...
    @hybridmethod
    def _gen_cache_key_inst(self, anon_map: Any, bindparams: List[BindParameter[Any]]) -> Optional[Tuple[Any]]:
        return HasCacheKey._gen_cache_key(self, anon_map, bindparams)

    @_gen_cache_key_inst.classlevel
    def _gen_cache_key(cls, anon_map: "anon_map", bindparams: List[BindParameter[Any]]) -> Tuple[CacheableOptions, Any]:
        return (cls, ())
