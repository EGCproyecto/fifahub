...
class SuiteRequirements(Requirements):
    ...
    def up_to_date_typealias_type(self):
        ...
        def check(config):
            ...
            TypeAliasType = getattr(typing, "TypeAliasType", typing_extensions.TypeAliasType)
            TV = typing.TypeVar("TV")
            TA_generic = TypeAliasType("TA_generic", typing.List[TV], type_params=(TV,))  # type: ignore
    ...
    def fail_python314b1(self):
        return exclusions.fails_if(lambda: util.compat.py314b1, "Fails as of python 3.14.0b1")
    ...
    def not_python314(self):
        ...
        """
        return exclusions.skip_if(lambda: util.py314, "Python 3.14 or above not supported")
