...
class EnumTest(_LiteralRoundTripFixture, fixtures.TablesTest):
    ...
    def test_round_trip(self, data, connection):
        ...
        eq_(
            connection.scalar(select(self.tables.enum_table.c.enum_data).where(self.tables.enum_table.c.id == 1)),
            data,
        )
    ...
    def test_round_trip_executemany(self, connection):
        ...
        eq_(
            connection.scalars(select(self.tables.enum_table.c.enum_data).order_by(self.tables.enum_table.c.id)).all(),
