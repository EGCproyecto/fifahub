...
def fixup_container_fwd_refs(
    ...
    if (
        ...
        return get_origin(type_).__class_getitem__(  # type: ignore
            tuple([ForwardRef(elem) if isinstance(elem, str) else elem for elem in get_args(type_)])
        )
    return type_
...
def is_fwd_ref(
    ...
    if check_for_plain_string and isinstance(type_, str):
        ...
        return any(is_fwd_ref(arg, True, check_for_plain_string=check_for_plain_string) for arg in type_.__args__)
    else:
        return False
...
@overload
def _de_optionalize_fwd_ref_union_types(type_: ForwardRef, return_has_none: Literal[True]) -> bool: ...


@overload
def _de_optionalize_fwd_ref_union_types(type_: ForwardRef, return_has_none: Literal[False]) -> _AnnotationScanType: ...


def _de_optionalize_fwd_ref_union_types(type_: ForwardRef, return_has_none: bool) -> Union[_AnnotationScanType, bool]:
