...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from sqlalchemy.cyextension.immutabledict import ImmutableDictBase as ImmutableDictBase
    from sqlalchemy.cyextension.immutabledict import ReadOnlyContainer as ReadOnlyContainer
...
def update_copy(d: Dict[Any, Any], _new: Optional[Dict[Any, Any]] = None, **kw: Any) -> Dict[Any, Any]:
