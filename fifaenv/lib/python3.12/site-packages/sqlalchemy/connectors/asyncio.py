...
import collections
import sys
from typing import TYPE_CHECKING, Any, AsyncIterator, Deque, Iterator, NoReturn, Optional, Sequence
...
class AsyncAdapt_dbapi_cursor:
    ...
    async def _execute_async(self, operation: Any, parameters: Optional[_DBAPISingleExecuteParams]) -> Any:
