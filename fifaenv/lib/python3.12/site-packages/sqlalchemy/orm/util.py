...
from .interfaces import ORMColumnsClauseRole, ORMEntityColumnsClauseRole, ORMFromClauseRole
...
def _extract_mapped_subtype(
    ...
    if is_dataclass_field:
        ...
        if len(annotated.__args__) != 1:
            raise orm_exc.MappedAnnotationError("Expected sub-type for Mapped[] annotation")
