...
class AsyncConnection(
    ...
    @classmethod
    def _regenerate_proxy_for_target(cls, target: Connection, **additional_kw: Any) -> AsyncConnection:  # noqa: U100
...
class AsyncEngine(ProxyComparable[Engine], AsyncConnectable):
    ...
    @classmethod
    def _regenerate_proxy_for_target(cls, target: Engine, **additional_kw: Any) -> AsyncEngine:  # noqa: U100
...
class AsyncTransaction(ProxyComparable[Transaction], StartableContext["AsyncTransaction"]):
    ...
    @classmethod
    def _regenerate_proxy_for_target(cls, target: Transaction, **additional_kw: Any) -> AsyncTransaction:  # noqa: U100
