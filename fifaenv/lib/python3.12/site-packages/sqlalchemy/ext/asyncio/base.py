...
class ReversibleProxy(Generic[_PT]):
    ...
    @overload
    @classmethod
    def _retrieve_proxy_for_target(cls, target: _PT, regenerate: Literal[True] = ..., **additional_kw: Any) -> Self: ...
    ...
    @classmethod
    def _retrieve_proxy_for_target(cls, target: _PT, regenerate: bool = True, **additional_kw: Any) -> Optional[Self]:
        try:
