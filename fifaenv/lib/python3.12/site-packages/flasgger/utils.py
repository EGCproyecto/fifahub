...
from .marshmallow_apispec import Schema, SwaggerView, convert_schemas
...
def get_schema_specs(schema_id, swagger):
    ...
    with swagger.app.app_context():
        specs = get_specs(
            current_app.url_map.iter_rules(), ignore_verbs, optional_fields, swagger.sanitizer, openapi_version
        )
    ...
    for rule in rules:
        ...
        for verb, method in methods.items():
            ...
            if view_class and issubclass(view_class, SwaggerView):
                ...
                apispec_attrs = optional_fields + ["parameters", "definitions", "responses", "summary", "description"]
...
def extract_definitions(alist, level=None, endpoint=None, verb=None, prefix_ids=False, openapi_version=None):
    """
    ...
    for item in alist:
        ...
        if schema is not None:
            ...
            if properties is not None:
                defs += extract_definitions(properties.values(), level + 1, endpoint, verb, prefix_ids, openapi_version)
    ...
    def wrapper(*args, **kwargs):
        ...
        for variable, annotation in function.__annotations__.items():
            ...
            if issubclass(annotation, Schema):
                ...
                m = {"name": variable, "in": "path", "type": "integer", "required": True}
