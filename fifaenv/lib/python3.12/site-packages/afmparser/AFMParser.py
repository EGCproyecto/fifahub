        ...
        try:
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    if la_ == 1:
                        localctx = AFMParser.ArithmeticExpContext(
                            self, AFMParser.ExpressionContext(self, _parentctx, _parentState)
                        )
                        ...
                        localctx = AFMParser.RelationalExpContext(
                            self, AFMParser.ExpressionContext(self, _parentctx, _parentState)
                        )
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expression)
                        self.state = 291
                        ...
                        localctx = AFMParser.AndExpContext(
                            self, AFMParser.ExpressionContext(self, _parentctx, _parentState)
                        )
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expression)
                        self.state = 295
                        ...
                        localctx = AFMParser.OrExpContext(
                            self, AFMParser.ExpressionContext(self, _parentctx, _parentState)
                        )
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expression)
                        self.state = 298
                        ...
                        localctx = AFMParser.LogicalExpContext(
                            self, AFMParser.ExpressionContext(self, _parentctx, _parentState)
                        )
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expression)
                        self.state = 301
