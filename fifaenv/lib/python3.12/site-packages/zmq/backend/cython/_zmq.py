...
class Socket:
    ...
    def get(self, option: C.int):
        ...
        if opt_type == _OptType.bytes:
            ...
            try:
                ...
                if option == ZMQ_FD and e.errno == zmq.Errno.EINVAL and self.get(ZMQ_THREAD_SAFE):
                    ...
                    rc = zmq_poller_add(self._draft_poller, self.handle, NULL, ZMQ_POLLIN | ZMQ_POLLOUT)
                    _check_rc(rc)
    ...
    def recv(self, flags=0, copy: bint = True, track: bint = False):
        ...
        if copy:
            ...
            _getsockopt(self.handle, ZMQ_RCVMORE, cast(p_void, address(more)), address(sz))
            frame.more = more
            return frame
