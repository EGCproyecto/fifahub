...
class Socket:
    ...
    def get(self, option):
        ...
        try:
            ...
            if option == SocketOption.FD and e.errno == zmq.Errno.EINVAL and self.get(SocketOption.THREAD_SAFE):
                ...
                rc = C.zmq_poller_fd(self._draft_poller, ffi.cast("void *", c_value_pointer))
                _check_rc(rc)
                return int(c_value_pointer[0])
            else:
                raise
