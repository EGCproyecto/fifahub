...
class _AsyncSocket(_zmq.Socket[Future]):
    ...
    def recv_into(self, buffer: Any, /, *, nbytes: int = 0, flags: int = 0) -> Awaitable[int]: ...  # type: ignore
    ...
    def recv_string(self, flags: int = 0, encoding: str = "utf-8") -> Awaitable[str]: ...  # type: ignore
    ...
    def send_json(self, obj: Any, flags: int = 0, **kwargs) -> Awaitable[_zmq.Frame | None]: ...  # type: ignore
