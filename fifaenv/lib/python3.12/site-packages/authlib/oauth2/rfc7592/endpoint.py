...
from ..rfc6749 import AccessDeniedError, InvalidClientError, InvalidRequestError, UnauthorizedClientError
...
class ClientConfigurationEndpoint:
    ...
    def create_configuration_response(self, request):
        ...
        if not client:
            ...
            raise InvalidClientError(status_code=401, description="The client does not exist on this server.")
