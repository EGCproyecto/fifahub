...
class CloseReason:
    ...
    def __repr__(self) -> str:
        ...
        return f"{self.__class__.__name__}" f"<code={self.code}, name={self.name}, reason={self.reason}>"
...
class WebSocketConnection(trio.abc.AsyncResource):
    ...
    def __init__(
        ...
        *,
        ...
        self._reject_body = b""
        self._send_channel, self._recv_channel = trio.open_memory_channel[Union[bytes, str]](message_queue_size)
    ...
    async def _get_request(self) -> WebSocketRequest:
        ...
        if self._connection_proposal is None:
            raise RuntimeError(
                "No proposal available. Did you call this method" " multiple times or at the wrong time?"
            )
