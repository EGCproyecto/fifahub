...
if True:
    ...
    from sqlalchemy.util import inspect_getfullargspec as inspect_getfullargspec  # noqa: F401
    from sqlalchemy.util.compat import inspect_formatargspec as inspect_formatargspec  # noqa: F401
