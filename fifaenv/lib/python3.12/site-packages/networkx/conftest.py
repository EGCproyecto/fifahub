...
def pytest_addoption(parser):
    ...
    parser.addoption(
        ...
        action="store_true",
        default=False,
        help="Run nx function if a backend doesn't implement a dispatchable function" " (use with --backend)",
    )
...
def pytest_configure(config):
    ...
    if backend:
        ...
        nx.utils.backends._dispatchable.__call__ = nx.utils.backends._dispatchable._call_if_any_backends_installed
...
def set_warnings():
    ...
    warnings.filterwarnings("ignore", category=DeprecationWarning, message="Keyword argument 'link'")
