...
class TestResourceAllocationIndex:
    ...
    def test_notimplemented(self, graph_type):
        pytest.raises(nx.NetworkXNotImplemented, self.func, graph_type([(0, 1), (1, 2)]), [(0, 2)])
...
class TestCNSoundarajanHopcroft:
    ...
    def setup_class(cls):
        ...
        cls.test = staticmethod(partial(_test_func, predict_func=cls.func, community="community"))
