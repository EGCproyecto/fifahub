...
class TestSimilarity:
    ...
    def test_generate_random_paths_unweighted(self):
        ...
        G.add_edge(1, 2)
        G.add_edge(2, 4)
        paths = nx.generate_random_paths(G, num_paths, path_length=path_length, index_map=index_map, seed=42)
        expected_paths = [
            [3, 0, 3],
            [4, 2, 1],
            [2, 1, 0],
    ...
    def test_symmetry_with_custom_matching(self):
        ...
        assert nx.graph_edit_distance(G2, G3, node_match=user_match, edge_match=user_match) == 1
        assert nx.graph_edit_distance(G3, G2, node_match=user_match, edge_match=user_match) == 1
