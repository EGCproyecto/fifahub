...
def _heuristic(k, root, DF_tree, D, nodes, greedy):
    ...
    for x in nodes:
        for y in nodes:
            ...
            if y != added_node:
                DF_tree.nodes[node_p]["betweenness"].loc[y, x] -= root_node["betweenness"][x][added_node] * dxyv
            if x != added_node:
                DF_tree.nodes[node_p]["betweenness"].loc[y, x] -= root_node["betweenness"][added_node][y] * dvxy
