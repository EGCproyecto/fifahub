...
no_backends_for_leiden_communities = "not set(nx.config.backend_priority.algos) & leiden_communities.backends"

no_backends_for_leiden_partitions = "not set(nx.config.backend_priority.algos) & leiden_partitions.backends"
