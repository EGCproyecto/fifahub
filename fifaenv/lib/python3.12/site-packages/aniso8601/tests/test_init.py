...
class TestInitFunctions(unittest.TestCase):
    def test_import(self):
        ...
        self.assertEqual(aniso8601.get_time_resolution, aniso8601.time.get_time_resolution)
        self.assertEqual(aniso8601.get_datetime_resolution, aniso8601.time.get_datetime_resolution)

        self.assertEqual(aniso8601.parse_date, aniso8601.date.parse_date)
        self.assertEqual(aniso8601.get_date_resolution, aniso8601.date.get_date_resolution)
