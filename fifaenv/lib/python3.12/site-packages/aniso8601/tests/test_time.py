...
class TestTimeParserFunctions(unittest.TestCase):
    ...
    def test_parse_datetime(self):
        testtuples = (
            ...
            (
                ...
                (
                    DateTuple("1981", "04", "05", None, None, None),
                    TimeTuple("23", "21", "28", TimezoneTuple(False, None, "00", None, "+00")),
                ),
            ),
            (
    ...
    def test_parse_datetime_spacedelimited(self):
        expectedargs = (
            ...
            TimeTuple("23", "21", "28.512400", TimezoneTuple(True, None, "12", "34", "-12:34")),
        )
    ...
    def test_parse_datetime_commadelimited(self):
        expectedargs = (
            DateTuple("1981", "04", "05", None, None, None),
            TimeTuple("23", "21", "28.512400", TimezoneTuple(False, True, None, None, "Z")),
        )
