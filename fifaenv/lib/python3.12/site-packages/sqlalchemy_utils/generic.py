...
class GenericAttributeImpl(attributes.ScalarAttributeImpl):
    ...
    def set(self, state, dict_, initiator, passive=attributes.PASSIVE_OFF, check_old=None, pop=False):
...
class GenericRelationshipProperty(MapperProperty):
    ...
    class Comparator(PropComparator):
        ...
        def is_type(self, other):
            ...
            class_names.extend([submapper.class_.__name__ for submapper in mapper._inheriting_mappers])
