...
def is_case_insensitive(mixed):
    try:
        ...
        try:
            return issubclass(inspect_type(mixed).comparator_factory, CaseInsensitiveComparator)
        except AttributeError:
            return False
...
for func in string_operator_funcs:
    setattr(CaseInsensitiveComparator, func, CaseInsensitiveComparator.lowercase_arg(func))
