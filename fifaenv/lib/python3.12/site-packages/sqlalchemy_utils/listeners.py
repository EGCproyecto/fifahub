...
def auto_delete_orphans(attr):
    ...
    if not backref:
        raise ImproperlyConfigured(
            "The relationship argument given for auto_delete_orphans needs to " "have a backref relationship set."
        )
    ...
    def delete_orphan_listener(session, ctx):
        ...
        # orphans
        orphans_found = any(
            isinstance(obj, parent_class) and sa.orm.attributes.get_history(obj, attr.key).deleted
