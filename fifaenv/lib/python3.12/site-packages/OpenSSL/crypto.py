...
@deprecated("get_elliptic_curves is deprecated. You should use the APIs in " "cryptography instead.")
...
@deprecated("get_elliptic_curve is deprecated. You should use the APIs in " "cryptography instead.")
...
@deprecated("CSR support in pyOpenSSL is deprecated. You should use the APIs " "in cryptography.")
class X509Req:
    """
...
class X509Store:
    ...
    def add_crl(self, crl: x509.CertificateRevocationList) -> None:
        ...
        if isinstance(crl, x509.CertificateRevocationList):
            ...
            raise TypeError("CRL must be of type " "cryptography.x509.CertificateRevocationList")
