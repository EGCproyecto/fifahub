...
class _ALPNSelectHelper(_CallbackExceptionHelper):
    ...
    def __init__(self, callback: _ALPNSelectCallback) -> None:
        ...
        self.callback = _ffi.callback(
            ("int (*)(SSL *, unsigned char **, unsigned char *, " "const unsigned char *, unsigned int, void *)"),
            wrapper,
        )
...
_requires_keylog = _make_requires(getattr(_lib, "Cryptography_HAS_KEYLOG", 0), "Key logging not available")
...
class Context:
    ...
    def __init__(self, method: int) -> None:
        ...
        self._ocsp_helper: _OCSPClientCallbackHelper | _OCSPServerCallbackHelper | None = None
        self._ocsp_callback: _OCSPClientCallback[Any] | _OCSPServerCallback[Any] | None = None
    ...
    def set_default_verify_paths(self) -> None:
        ...
        *   manylinux cryptography wheels will work on most common Linux
        ...
        if not self._check_env_vars_set("SSL_CERT_DIR", "SSL_CERT_FILE"):
            ...
            if default_dir == _CRYPTOGRAPHY_MANYLINUX_CA_DIR and default_file == _CRYPTOGRAPHY_MANYLINUX_CA_FILE:
    ...
    def _fallback_default_verify_paths(self, file_path: list[str], dir_path: list[str]) -> None:
        """
    ...
    @_require_not_used
    def use_certificate_file(self, certfile: _StrOrBytesPath, filetype: int = FILETYPE_PEM) -> None:
        """
    ...
    @_require_not_used
    def use_privatekey_file(self, keyfile: _StrOrBytesPath, filetype: int = FILETYPE_PEM) -> None:
        """
    ...
    def use_privatekey(self, pkey: _PrivateKey | PKey) -> None:
        ...
        if not isinstance(pkey, PKey):
            ...
            warnings.warn(
                ("Passing pyOpenSSL PKey objects is deprecated. You " "should use a cryptography private key instead."),
                DeprecationWarning,
                stacklevel=2,
            )
        ...
        try:
            for ca_name in certificate_authorities:
                if not isinstance(ca_name, X509Name):
                    raise TypeError(f"client CAs must be X509Name objects, not " f"{type(ca_name).__name__} objects")
    ...
    @_require_not_used
    def set_info_callback(self, callback: Callable[[Connection, int, int], None]) -> None:
        """
    ...
    @_require_not_used
    def set_tlsext_servername_callback(self, callback: Callable[[Connection], None]) -> None:
        """
...
class Connection:
    ...
    def export_keying_material(self, label: bytes, olen: int, context: bytes | None = None) -> bytes:
        """
    ...
    @typing.overload
    def get_certificate(self, *, as_cryptography: typing.Literal[True]) -> x509.Certificate | None:
        pass

    @typing.overload
    def get_certificate(self, *, as_cryptography: typing.Literal[False] = False) -> X509 | None:
        pass
    ...
    @typing.overload
    def get_peer_certificate(self, *, as_cryptography: typing.Literal[True]) -> x509.Certificate | None:
        pass

    @typing.overload
    def get_peer_certificate(self, *, as_cryptography: typing.Literal[False] = False) -> X509 | None:
        pass
    ...
    @typing.overload
    def get_peer_cert_chain(self, *, as_cryptography: typing.Literal[True]) -> list[x509.Certificate] | None:
        pass

    @typing.overload
    def get_peer_cert_chain(self, *, as_cryptography: typing.Literal[False] = False) -> list[X509] | None:
        pass
    ...
    @typing.overload
    def get_verified_chain(self, *, as_cryptography: typing.Literal[True]) -> list[x509.Certificate] | None:
        pass

    @typing.overload
    def get_verified_chain(self, *, as_cryptography: typing.Literal[False] = False) -> list[X509] | None:
        pass
    ...
    def _get_finished_message(self, function: Callable[[Any, Any, int], int]) -> bytes | None:
        """
