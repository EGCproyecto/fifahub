...
from flamapy.core.models import AST, ASTOperation, VariabilityElement, VariabilityModel
from flamapy.core.models.ast import propagate_negation, simplify_formula, to_cnf


class Relation:
    def __init__(self, parent: "Feature", children: list["Feature"], card_min: int, card_max: int) -> None:
        self.parent = parent
    ...
    def is_cardinal(self) -> bool:
        return self.is_group() and not self.is_alternative() and not self.is_or() and not self.is_mutex()
...
class Constraint:
    ...
    def is_pseudocomplex_constraint(self) -> bool:
        ...
        return len(split_ctcs) > 1 and all(ctc.is_simple_constraint() for ctc in split_ctcs)
