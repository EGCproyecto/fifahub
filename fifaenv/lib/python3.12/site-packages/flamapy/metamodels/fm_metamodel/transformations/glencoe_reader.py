...
class GlencoeReader(TextToModel):
    ...
    def _parse_constraints(self, ctcs_info: dict[str, Any], features_info: dict[str, Any]) -> list[Constraint]:
        constraints = []
    ...
    def _parse_ast_constraint(self, ctc_info: dict[str, Any], features_info: dict[str, Any]) -> Node:
