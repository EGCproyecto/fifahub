...
from afmparser import AFMParser, get_tree
...
class AFMReader(TextToModel):
    ...
    def read_children(self, feature_spec: AFMParser.Relationship_specContext) -> None:
        ...
        parent_feature = self.model.get_feature_by_name(feature_spec.init_spec().WORD().getText())
    ...
    def read_attribute(self, attribute_spec: AFMParser.Attribute_specContext) -> None:
        ...
        attribute_feature = self.model.get_feature_by_name(attribute_name_node.WORD().getText())
    ...
    def build_ast_node(self, expression: AFMParser.ExpressionContext, prefix: str) -> Node:
        ...
        if expression.__class__ in binary_operation_types:
            ...
            if ast_operation is None:
                raise FlamaException(f"Constraints not supported in AFM Reader: {binary_operation}.")
        ...
        if result is None:
            raise FlamaException(f"Constraint not support in AFM Reader: {expression}, {prefix}")
