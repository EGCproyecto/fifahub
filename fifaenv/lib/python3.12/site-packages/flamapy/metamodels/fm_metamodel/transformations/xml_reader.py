...
class XMLReader(TextToModel):
    ...
    def parse_ctc(self, element: ElementTree.Element) -> Constraint:
        ...
        return Constraint(name, AST.create_simple_binary_operation(operator_type, origin.name, destination.name))
    ...
    def parse_feature(self, element: ElementTree.Element, parent: Optional[Feature]) -> Feature:
        ...
        for child in element:
            if feature is not None and (
                child.tag.casefold() == "setrelation" or child.tag.casefold() == "binaryrelation"
            ):
