...
class TextCNFModel:
    ...
    def write_textual_cnf_file(self, filepath: str, syntax: TextCNFNotation = TextCNFNotation.JAVA_SHORT) -> None:
    ...
    def get_textual_cnf_formula(self, syntax: Optional[TextCNFNotation] = None) -> str:
