...
from .. import utils
from ..utils import contains, diff
from .labeler.labeler import AbstractHSParameters, IHSLabelable, LabelerType
...
class HSDAG:
    ...
    def can_prune(self, node_2prime: Node) -> bool:
        ...
        for node in self.open_nodes:
            if (
                len(node.path_label) == len(node_2prime.path_label)
