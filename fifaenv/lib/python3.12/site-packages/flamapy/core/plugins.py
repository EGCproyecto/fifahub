...
class Plugin:
    ...
    def __get_transformation(self, filter_transformation: Callable[..., bool]) -> Type[Transformation]:
    ...
    def use_transformation_t2m(self, src: str) -> VariabilityModel:
        ...
        def filter_transformations(transformation: Type[Transformation]) -> bool:
            return issubclass(transformation, TextToModel) and transformation.get_source_extension() == extension

        transformation: Type[TextToModel] = cast(Type[TextToModel], self.__get_transformation(filter_transformations))
    ...
    def use_transformation_m2t(self, src: VariabilityModel, dst: str) -> str:
        ...
        def filter_transformations(transformation: Type[Transformation]) -> bool:
            return issubclass(transformation, ModelToText) and transformation.get_destination_extension() == extension

        transformation: Type[ModelToText] = cast(Type[ModelToText], self.__get_transformation(filter_transformations))
    ...
    def use_transformation_m2m(self, src: VariabilityModel, dst: str) -> VariabilityModel:
        ...
        transformation: Type[ModelToModel] = cast(Type[ModelToModel], self.__get_transformation(filter_transformations))
        result = transformation(src)
        return result.transform()
