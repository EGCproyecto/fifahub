...
class Payload:
    ...
    def encode(self, jsonp_index=None):
        ...
        if jsonp_index is not None:
            encoded_payload = "___eio[" + str(jsonp_index) + ']("' + encoded_payload.replace('"', '\\"') + '");'
    ...
    def decode(self, encoded_payload):
        ...
        self.packets = [packet.Packet(encoded_packet=encoded_packet) for encoded_packet in encoded_packets]
