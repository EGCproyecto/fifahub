...
class Node:
    ...
    def from_json(cls, json):
        return cls(
            ...
            distributed_nodes=(
                [BackendNode.from_json(i) for i in json["distributedNodes"]] if "distributedNodes" in json else None
            ),
            is_svg=bool(json["isSVG"]) if "isSVG" in json else None,
            compatibility_mode=(
                CompatibilityMode.from_json(json["compatibilityMode"]) if "compatibilityMode" in json else None
            ),
...
class ScrollableFlagUpdated:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScrollableFlagUpdated:
        return cls(node_id=dom.NodeId.from_json(json["nodeId"]), is_scrollable=bool(json["isScrollable"]))
