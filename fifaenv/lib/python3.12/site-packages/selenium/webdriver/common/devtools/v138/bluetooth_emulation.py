    ...
    def from_json(cls, json):
        return cls(
            ...
            authenticated_signed_writes=(
                bool(json["authenticatedSignedWrites"]) if "authenticatedSignedWrites" in json else None
            ),
...
def simulate_preconnected_peripheral(
    address: str, name: str, manufacturer_data: typing.List[ManufacturerData], known_service_uuids: typing.List[str]
...
def simulate_characteristic_operation_response(
    characteristic_id: str, type_: CharacteristicOperationType, code: int, data: typing.Optional[str] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def simulate_descriptor_operation_response(
    descriptor_id: str, type_: DescriptorOperationType, code: int, data: typing.Optional[str] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
class GattOperationReceived:
    ...
    def from_json(cls, json: T_JSON_DICT) -> GattOperationReceived:
        return cls(address=str(json["address"]), type_=GATTOperationType.from_json(json["type"]))
