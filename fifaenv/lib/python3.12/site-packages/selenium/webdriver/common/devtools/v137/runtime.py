    ...
    def from_json(cls, json):
        return cls(
            ...
            weak_local_object_reference=(
                int(json["weakLocalObjectReference"]) if "weakLocalObjectReference" in json else None
            ),
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            unserializable_value=(
                UnserializableValue.from_json(json["unserializableValue"]) if "unserializableValue" in json else None
            ),
            description=str(json["description"]) if "description" in json else None,
            deep_serialized_value=(
                DeepSerializedValue.from_json(json["deepSerializedValue"]) if "deepSerializedValue" in json else None
            ),
    ...
    def from_json(cls, json):
        return cls(
            ...
            execution_context_id=(
                ExecutionContextId.from_json(json["executionContextId"]) if "executionContextId" in json else None
            ),
