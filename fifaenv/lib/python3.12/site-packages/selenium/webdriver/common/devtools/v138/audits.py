    ...
    def from_json(cls, json):
        return cls(
            ...
            source_code_location=(
                SourceCodeLocation.from_json(json["sourceCodeLocation"]) if "sourceCodeLocation" in json else None
            ),
            violating_node_id=(
                dom.BackendNodeId.from_json(json["violatingNodeId"]) if "violatingNodeId" in json else None
            ),
        )
...
class StylesheetLoadingIssueDetails:
    ...
    def from_json(cls, json):
        return cls(
            ...
            failed_request_info=(
                FailedRequestInfo.from_json(json["failedRequestInfo"]) if "failedRequestInfo" in json else None
            ),
        )
    ...
    def from_json(cls, json):
        return cls(
            cookie_issue_details=(
                CookieIssueDetails.from_json(json["cookieIssueDetails"]) if "cookieIssueDetails" in json else None
            ),
            ...
            heavy_ad_issue_details=(
                HeavyAdIssueDetails.from_json(json["heavyAdIssueDetails"]) if "heavyAdIssueDetails" in json else None
            ),
            content_security_policy_issue_details=(
                ContentSecurityPolicyIssueDetails.from_json(json["contentSecurityPolicyIssueDetails"])
            ...
            cors_issue_details=(
                CorsIssueDetails.from_json(json["corsIssueDetails"]) if "corsIssueDetails" in json else None
            ),
            ...
            generic_issue_details=(
                GenericIssueDetails.from_json(json["genericIssueDetails"]) if "genericIssueDetails" in json else None
            ),
            ...
            cookie_deprecation_metadata_issue_details=(
                CookieDeprecationMetadataIssueDetails.from_json(json["cookieDeprecationMetadataIssueDetails"])
            ...
            federated_auth_user_info_request_issue_details=(
                FederatedAuthUserInfoRequestIssueDetails.from_json(json["federatedAuthUserInfoRequestIssueDetails"])
            ...
            select_element_accessibility_issue_details=(
                SelectElementAccessibilityIssueDetails.from_json(json["selectElementAccessibilityIssueDetails"])
