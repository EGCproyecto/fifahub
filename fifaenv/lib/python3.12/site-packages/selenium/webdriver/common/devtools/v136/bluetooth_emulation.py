...
def remove_service(address: str, service_id: str) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def add_characteristic(
    address: str, service_id: str, characteristic_uuid: str, properties: CharacteristicProperties
