...
class TargetInfo:
    ...
    def from_json(cls, json):
        return cls(
            ...
            browser_context_id=(
                browser.BrowserContextID.from_json(json["browserContextId"]) if "browserContextId" in json else None
            ),
...
def expose_dev_tools_protocol(
    target_id: TargetID, binding_name: typing.Optional[str] = None, inherit_permissions: typing.Optional[bool] = None
...
def auto_attach_related(
    target_id: TargetID, wait_for_debugger_on_start: bool, filter_: typing.Optional[TargetFilter] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
