...
class CSSRule:
    ...
    def from_json(cls, json):
        return cls(
            ...
            starting_styles=(
                [CSSStartingStyle.from_json(i) for i in json["startingStyles"]] if "startingStyles" in json else None
            ),
        )
...
class CSSProperty:
    ...
    def from_json(cls, json):
        return cls(
            ...
            range_=SourceRange.from_json(json["range"]) if "range" in json else None,
            longhand_properties=(
                [CSSProperty.from_json(i) for i in json["longhandProperties"]] if "longhandProperties" in json else None
            ),
        )
...
class CSSFunctionConditionNode:
    ...
    def from_json(cls, json):
        return cls(
            ...
            container_queries=(
                CSSContainerQuery.from_json(json["containerQueries"]) if "containerQueries" in json else None
            ),
...
def set_style_texts(
    edits: typing.List[StyleDeclarationEdit], node_for_property_syntax_validation: typing.Optional[dom.NodeId] = None
