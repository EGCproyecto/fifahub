...
class AdFrameStatus:
    ...
    def from_json(cls, json):
        return cls(
            ...
            explanations=(
                [AdFrameExplanation.from_json(i) for i in json["explanations"]] if "explanations" in json else None
            ),
        )
...
class FrameResourceTree:
    ...
    def from_json(cls, json):
        return cls(
            ...
            child_frames=(
                [FrameResourceTree.from_json(i) for i in json["childFrames"]] if "childFrames" in json else None
            ),
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            prefer_related_applications=(
                bool(json["preferRelatedApplications"]) if "preferRelatedApplications" in json else None
            ),
            protocol_handlers=(
                [ProtocolHandler.from_json(i) for i in json["protocolHandlers"]] if "protocolHandlers" in json else None
            ),
            ...
            scope_extensions=(
                [ScopeExtension.from_json(i) for i in json["scopeExtensions"]] if "scopeExtensions" in json else None
            ),
...
class BackForwardCacheNotRestoredExplanation:
    ...
    def from_json(cls, json):
        return cls(
            ...
            details=(
                [BackForwardCacheBlockingDetails.from_json(i) for i in json["details"]] if "details" in json else None
            ),
        )
...
def get_app_id() -> (
    typing.Generator[T_JSON_DICT, T_JSON_DICT, typing.Tuple[typing.Optional[str], typing.Optional[str]]]
):
    """
...
class JavascriptDialogClosed:
    ...
    def from_json(cls, json: T_JSON_DICT) -> JavascriptDialogClosed:
        return cls(
            frame_id=FrameId.from_json(json["frameId"]), result=bool(json["result"]), user_input=str(json["userInput"])
        )
    ...
    def from_json(cls, json: T_JSON_DICT) -> BackForwardCacheNotUsed:
        return cls(
            ...
            not_restored_explanations_tree=(
                BackForwardCacheNotRestoredExplanationTree.from_json(json["notRestoredExplanationsTree"])
