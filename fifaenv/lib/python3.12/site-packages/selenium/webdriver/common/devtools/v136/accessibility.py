...
class AXValue:
    ...
    def from_json(cls, json):
        return cls(
            ...
            related_nodes=(
                [AXRelatedNode.from_json(i) for i in json["relatedNodes"]] if "relatedNodes" in json else None
            ),
...
class AXNode:
    ...
    def from_json(cls, json):
        return cls(
            ...
            ignored_reasons=(
                [AXProperty.from_json(i) for i in json["ignoredReasons"]] if "ignoredReasons" in json else None
            ),
            ...
            backend_dom_node_id=(
                dom.BackendNodeId.from_json(json["backendDOMNodeId"]) if "backendDOMNodeId" in json else None
            ),
