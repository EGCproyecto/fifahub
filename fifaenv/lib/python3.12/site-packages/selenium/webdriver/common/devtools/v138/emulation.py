...
def set_pressure_source_override_enabled(
    enabled: bool, source: PressureSource, metadata: typing.Optional[PressureMetadata] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
def set_pressure_data_override(
    source: PressureSource, state: PressureState, own_contribution_estimate: typing.Optional[float] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
