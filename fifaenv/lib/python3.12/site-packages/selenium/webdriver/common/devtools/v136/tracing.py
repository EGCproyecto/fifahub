...
class TraceConfig:
    ...
    def from_json(cls, json):
        return cls(
            ...
            memory_dump_config=(
                MemoryDumpConfig.from_json(json["memoryDumpConfig"]) if "memoryDumpConfig" in json else None
            ),
        )
...
class TracingComplete:
    ...
    def from_json(cls, json: T_JSON_DICT) -> TracingComplete:
        return cls(
            ...
            stream_compression=(
                StreamCompression.from_json(json["streamCompression"]) if "streamCompression" in json else None
            ),
        )
