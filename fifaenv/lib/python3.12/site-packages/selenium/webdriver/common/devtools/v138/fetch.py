    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestPaused:
        return cls(
            ...
            response_error_reason=(
                network.ErrorReason.from_json(json["responseErrorReason"]) if "responseErrorReason" in json else None
            ),
            ...
            response_headers=(
                [HeaderEntry.from_json(i) for i in json["responseHeaders"]] if "responseHeaders" in json else None
            ),
            network_id=network.RequestId.from_json(json["networkId"]) if "networkId" in json else None,
            redirected_request_id=(
                RequestId.from_json(json["redirectedRequestId"]) if "redirectedRequestId" in json else None
            ),
        )
