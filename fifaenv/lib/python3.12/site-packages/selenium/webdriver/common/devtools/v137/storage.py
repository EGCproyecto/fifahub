    ...
    def from_json(cls, json):
        return cls(
            ...
            aggregation_coordinator_origin=(
                str(json["aggregationCoordinatorOrigin"]) if "aggregationCoordinatorOrigin" in json else None
            ),
    ...
    def from_json(cls, json):
        return cls(
            ...
            aggregatable_dedup_keys=[
                AttributionReportingAggregatableDedupKey.from_json(i) for i in json["aggregatableDedupKeys"]
            ],
            event_trigger_data=[AttributionReportingEventTriggerData.from_json(i) for i in json["eventTriggerData"]],
            aggregatable_trigger_data=[
                AttributionReportingAggregatableTriggerData.from_json(i) for i in json["aggregatableTriggerData"]
            ],
            aggregatable_values=[
                AttributionReportingAggregatableValueEntry.from_json(i) for i in json["aggregatableValues"]
            ],
...
def set_shared_storage_entry(
    owner_origin: str, key: str, value: str, ignore_if_present: typing.Optional[bool] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
...
class InterestGroupAccessed:
    ...
    def from_json(cls, json: T_JSON_DICT) -> InterestGroupAccessed:
        return cls(
            ...
            unique_auction_id=(
                InterestGroupAuctionId.from_json(json["uniqueAuctionId"]) if "uniqueAuctionId" in json else None
            ),
        )
...
class InterestGroupAuctionEventOccurred:
    ...
    def from_json(cls, json: T_JSON_DICT) -> InterestGroupAuctionEventOccurred:
        return cls(
            ...
            parent_auction_id=(
                InterestGroupAuctionId.from_json(json["parentAuctionId"]) if "parentAuctionId" in json else None
            ),
