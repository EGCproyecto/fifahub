...
def restart_frame(call_frame_id: CallFrameId, mode: typing.Optional[str] = None) -> typing.Generator[
    T_JSON_DICT,
    T_JSON_DICT,
...
class ScriptFailedToParse:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScriptFailedToParse:
        return cls(
            ...
            script_language=(
                debugger.ScriptLanguage.from_json(json["scriptLanguage"]) if "scriptLanguage" in json else None
            ),
...
class ScriptParsed:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScriptParsed:
        return cls(
            ...
            debug_symbols=(
                [debugger.DebugSymbols.from_json(i) for i in json["debugSymbols"]] if "debugSymbols" in json else None
            ),
            embedder_name=str(json["embedderName"]) if "embedderName" in json else None,
