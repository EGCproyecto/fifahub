    ...
    def from_json(cls, json):
        return cls(
            ...
            pseudo_element_indexes=(
                [int(i) for i in json["pseudoElementIndexes"]] if "pseudoElementIndexes" in json else None
            ),
...
class LayoutTreeNode:
    ...
    def from_json(cls, json):
        return cls(
            ...
            inline_text_nodes=(
                [InlineTextBox.from_json(i) for i in json["inlineTextNodes"]] if "inlineTextNodes" in json else None
            ),
...
class NodeTreeSnapshot:
    ...
    def from_json(cls, json):
        return cls(
            ...
            backend_node_id=(
                [dom.BackendNodeId.from_json(i) for i in json["backendNodeId"]] if "backendNodeId" in json else None
            ),
            ...
            content_document_index=(
                RareIntegerData.from_json(json["contentDocumentIndex"]) if "contentDocumentIndex" in json else None
            ),
            pseudo_type=RareStringData.from_json(json["pseudoType"]) if "pseudoType" in json else None,
            pseudo_identifier=(
                RareStringData.from_json(json["pseudoIdentifier"]) if "pseudoIdentifier" in json else None
            ),
            is_clickable=RareBooleanData.from_json(json["isClickable"]) if "isClickable" in json else None,
            current_source_url=(
                RareStringData.from_json(json["currentSourceURL"]) if "currentSourceURL" in json else None
            ),
    ...
    def from_json(cls, json):
        return cls(
            ...
            text_color_opacities=(
                [float(i) for i in json["textColorOpacities"]] if "textColorOpacities" in json else None
            ),
        )
