    ...
    def from_json(cls, json):
        return cls(
            ...
            worker_router_evaluation_start=(
                float(json["workerRouterEvaluationStart"]) if "workerRouterEvaluationStart" in json else None
            ),
...
class Request:
    ...
    def from_json(cls, json):
        return cls(
            ...
            post_data_entries=(
                [PostDataEntry.from_json(i) for i in json["postDataEntries"]] if "postDataEntries" in json else None
            ),
            mixed_content_type=(
                security.MixedContentType.from_json(json["mixedContentType"]) if "mixedContentType" in json else None
            ),
            is_link_preload=bool(json["isLinkPreload"]) if "isLinkPreload" in json else None,
            trust_token_params=(
                TrustTokenParams.from_json(json["trustTokenParams"]) if "trustTokenParams" in json else None
            ),
    ...
    def from_json(cls, json):
        return cls(
            ...
            server_signature_algorithm=(
                int(json["serverSignatureAlgorithm"]) if "serverSignatureAlgorithm" in json else None
            ),
        )
...
class ServiceWorkerRouterInfo:
    ...
    def from_json(cls, json):
        return cls(
            ...
            matched_source_type=(
                ServiceWorkerRouterSource.from_json(json["matchedSourceType"]) if "matchedSourceType" in json else None
            ),
            actual_source_type=(
                ServiceWorkerRouterSource.from_json(json["actualSourceType"]) if "actualSourceType" in json else None
            ),
        )
...
class AssociatedCookie:
    ...
    def from_json(cls, json):
        return cls(
            ...
            exemption_reason=(
                CookieExemptionReason.from_json(json["exemptionReason"]) if "exemptionReason" in json else None
            ),
        )
...
class RequestPattern:
    ...
    def from_json(cls, json):
        return cls(
            ...
            interception_stage=(
                InterceptionStage.from_json(json["interceptionStage"]) if "interceptionStage" in json else None
            ),
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            report_only_reporting_endpoint=(
                str(json["reportOnlyReportingEndpoint"]) if "reportOnlyReportingEndpoint" in json else None
            ),
        )
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestIntercepted:
        return cls(
            ...
            response_error_reason=(
                ErrorReason.from_json(json["responseErrorReason"]) if "responseErrorReason" in json else None
            ),
...
class DirectTCPSocketClosed:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> DirectTCPSocketClosed:
        return cls(
            identifier=RequestId.from_json(json["identifier"]), timestamp=MonotonicTime.from_json(json["timestamp"])
        )
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestWillBeSentExtraInfo:
        return cls(
            ...
            client_security_state=(
                ClientSecurityState.from_json(json["clientSecurityState"]) if "clientSecurityState" in json else None
            ),
            site_has_cookie_in_other_partition=(
                bool(json["siteHasCookieInOtherPartition"]) if "siteHasCookieInOtherPartition" in json else None
            ),
        )
    ...
    def from_json(cls, json: T_JSON_DICT) -> ResponseReceivedExtraInfo:
        return cls(
            ...
            cookie_partition_key=(
                CookiePartitionKey.from_json(json["cookiePartitionKey"]) if "cookiePartitionKey" in json else None
            ),
            cookie_partition_key_opaque=(
                bool(json["cookiePartitionKeyOpaque"]) if "cookiePartitionKeyOpaque" in json else None
            ),
            exempted_cookies=(
...
class ResponseReceivedEarlyHints:
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> ResponseReceivedEarlyHints:
        return cls(request_id=RequestId.from_json(json["requestId"]), headers=Headers.from_json(json["headers"]))
