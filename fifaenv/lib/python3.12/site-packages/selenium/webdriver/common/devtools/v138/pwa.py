...
def get_os_app_state(
    ...
    json = yield cmd_dict
    return (int(json["badgeCount"]), [FileHandler.from_json(i) for i in json["fileHandlers"]])
...
def change_app_user_settings(
    manifest_id: str, link_capturing: typing.Optional[bool] = None, display_mode: typing.Optional[DisplayMode] = None
) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:
    """
