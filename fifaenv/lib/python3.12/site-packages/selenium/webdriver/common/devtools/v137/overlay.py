    ...
    def from_json(cls, json):
        return cls(
            ...
            grid_background_color=(
                dom.RGBA.from_json(json["gridBackgroundColor"]) if "gridBackgroundColor" in json else None
            ),
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            main_distributed_space=(
                BoxStyle.from_json(json["mainDistributedSpace"]) if "mainDistributedSpace" in json else None
            ),
            cross_distributed_space=(
                BoxStyle.from_json(json["crossDistributedSpace"]) if "crossDistributedSpace" in json else None
            ),
    ...
    def from_json(cls, json):
        return cls(
            ...
            grid_highlight_config=(
                GridHighlightConfig.from_json(json["gridHighlightConfig"]) if "gridHighlightConfig" in json else None
            ),
            ...
            contrast_algorithm=(
                ContrastAlgorithm.from_json(json["contrastAlgorithm"]) if "contrastAlgorithm" in json else None
            ),
            container_query_container_highlight_config=(
                ContainerQueryContainerHighlightConfig.from_json(json["containerQueryContainerHighlightConfig"])
    ...
    def from_json(cls, json):
        return cls(
            ...
            scroll_padding_color=(
                dom.RGBA.from_json(json["scrollPaddingColor"]) if "scrollPaddingColor" in json else None
            ),
        )
    ...
    def from_json(cls, json):
        return cls(
            ...
            resizer_handle_color=(
                dom.RGBA.from_json(json["resizerHandleColor"]) if "resizerHandleColor" in json else None
            ),
