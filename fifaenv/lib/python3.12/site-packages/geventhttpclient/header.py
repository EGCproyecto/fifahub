...
class Headers(dict):
    ...
    def iteroriginal(self):
        ...
        warnings.warn(
            "This is deprecated and will be removed in version v2.3.0. " "Use Headers.items() instead.",
            DeprecationWarning,
            2,
        )
        return self.items()
    ...
    def iget(self, field):
        ...
        warnings.warn(
            "This is deprecated and will be removed in version v2.3.0. " "Use Headers.getlist() instead.",
            DeprecationWarning,
            2,
        )
