...
class OperaDriver(Driver):
    def __init__(
        self, name, driver_version, url, latest_release_url, opera_release_tag, http_client, os_system_manager
    ):
        super(OperaDriver, self).__init__(name, driver_version, url, latest_release_url, http_client, os_system_manager)
