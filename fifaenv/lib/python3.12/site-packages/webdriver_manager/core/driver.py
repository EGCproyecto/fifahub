...
class Driver(object):
    def __init__(self, name, driver_version_to_download, url, latest_release_url, http_client, os_system_manager):
        self._name = name
        self._url = url
    ...
    def get_binary_name(self, os_type):
        ...
        driver_binary_name = f"{driver_binary_name}.exe" if "win" in os_type else driver_binary_name
