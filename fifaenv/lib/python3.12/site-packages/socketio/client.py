...
class Client(base_client.BaseClient):
    ...
    def connect(
        ...
        try:
            self.eio.connect(real_url, headers=real_headers, transports=transports, engineio_path=socketio_path)
        except engineio.exceptions.ConnectionError as exc:
            for n in self.connection_namespaces:
                self._trigger_event("connect_error", n, exc.args[1] if len(exc.args) > 1 else exc.args[0])
    ...
    def emit(self, event, data=None, namespace=None, callback=None):
        ...
        if isinstance(data, tuple):
            ...
            data = []
        self._send_packet(self.packet_class(packet.EVENT, namespace=namespace, data=[event] + data, id=id))
    ...
    def _handle_event(self, namespace, id, data):
        ...
        if id is not None:
            ...
            if r is None:
                ...
                data = [r]
            self._send_packet(self.packet_class(packet.ACK, namespace=namespace, id=id, data=data))
    ...
    def _handle_eio_connect(self):
        ...
        for n in self.connection_namespaces:
            self._send_packet(self.packet_class(packet.CONNECT, data=real_auth, namespace=n))
