...
@click.option("-x", "--x-arg", multiple=True, help="Additional arguments consumed by custom env.py scripts")
@with_appcontext
...
@click.option(
    "--package", is_flag=True, help=("Write empty __init__.py files to the environment and " "version locations")
)
@with_appcontext
...
def migrate(directory, message, sql, head, splice, branch_label, version_path, rev_id, x_arg):
    ...
    _migrate(directory or g.directory, message, sql, head, splice, branch_label, version_path, rev_id, x_arg or g.x_arg)
...
@click.option("--sql", is_flag=True, help=("Don't emit SQL to database - dump to standard output " "instead"))
@click.option("--tag", default=None, help=('Arbitrary "tag" name - can be used by custom env.py ' "scripts"))
@click.option("--purge", is_flag=True, help=("Delete the version in the alembic_version table before " "stamping"))
@click.argument("revision", default="head")
@with_appcontext
