...
_BaseSelectorImpl = getattr(__selectors__, "_BaseSelectorImpl", __selectors__.BaseSelector)
...
def _gevent_do_monkey_patch(patch_request):
    ...
    if hasattr(SelectSelector, "_select") and SelectSelector._select in (target_mod.select, orig_select_select):
