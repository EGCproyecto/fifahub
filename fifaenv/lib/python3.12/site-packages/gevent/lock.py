...
_allocate_lock, _get_ident = monkey.get_original(("_thread", "thread"), ("allocate_lock", "get_ident"))
...
class RLock(object):
    ...
    def release(self):
        ...
        if self._owner is not getcurrent():
            raise RuntimeError("cannot release un-acquired lock. Owner: %r Current: %r" % (self._owner, getcurrent()))
