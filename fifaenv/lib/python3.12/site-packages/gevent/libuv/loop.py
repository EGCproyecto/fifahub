...
class loop(AbstractLoop):
    ...
    def _init_and_start_check(self):
        ...
        libuv.uv_timer_start(self._signal_idle, sig_cb, self.SIGNAL_CHECK_INTERVAL_MS, self.SIGNAL_CHECK_INTERVAL_MS)
    ...
    _HandleState = namedtuple("HandleState", ["handle", "type", "watcher", "ref", "active", "closing"])
    ...
    def debug(self):
        ...
        libuv.uv_walk(self.ptr, ffi.callback("void(*)(uv_handle_t*,void*)", walk), ffi.NULL)
        return handles
    ...
    def run(self, nowait=False, once=False):
        ...
        if mode == libuv.UV_RUN_DEFAULT:
            while self._ptr and self._ptr.data:
                ...
                # polling for IO.
                run_mode = (
                    libuv.UV_RUN_ONCE if not self._callbacks and not self._queued_callbacks else libuv.UV_RUN_NOWAIT
                )
    ...
    def install_sigchld(self):
        ...
        libuv.uv_signal_start(self._sigchld_watcher, libuv.python_sigchld_callback, signal.SIGCHLD)
