...
from gevent.testing.sysinfo import PY2, PYPY, RESOLVER_ARES, RESOLVER_DNSPYTHON, RESOLVER_NOT_SYSTEM
...
add(TestLocalhost, "ip6-localhost", skip=RESOLVER_DNSPYTHON, skip_reason="Can return gaierror(-2)")  # XXX: Fix these.
...
@greentest.skipIf(
    greentest.RUNNING_ON_CI, "This sometimes randomly fails on Travis with ares and on appveyor, beginning Feb 13, 2018"
)
...
add(TestInternational, "президент.рф".encode("idna"), "idna", require_equal_errors=False)
