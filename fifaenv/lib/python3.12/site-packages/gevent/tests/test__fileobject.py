...
class TestFileObjectBlock(CleanupMixin, greentest.TestCase):
    ...
    def test_text_encoding(self):
        gevent_data = self.__check_native_matches("\N{SNOWMAN}".encode("utf-8"), "r+", buffering=5, encoding="utf-8")
        self.assertIsInstance(gevent_data, str)
...
class TestFileObjectThread(ConcurrentFileObjectMixin, TestFileObjectBlock):  # pylint:disable=too-many-ancestors
...
class TestFileObjectPosix(ConcurrentFileObjectMixin, TestFileObjectBlock):  # pylint:disable=too-many-ancestors
