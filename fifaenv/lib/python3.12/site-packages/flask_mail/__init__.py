...
def sanitize_addresses(addresses: c.Iterable[str | tuple[str, str]], encoding: str = "utf-8") -> list[str]:
...
class Connection:
    ...
    def send(self, message: Message, envelope_from: str | tuple[str, str] | None = None) -> None:
        ...
        assert message.sender, "The message does not specify a sender and a default sender " "has not been configured"
...
class _MailMixin:
    ...
    def connect(self) -> Connection:
        ...
        try:
            ...
            raise RuntimeError("The current application was not configured with Flask-Mail") from err
...
class Mail(_MailMixin):
    ...
    def init_mail(self, config: dict[str, t.Any], debug: bool | int = False, testing: bool = False) -> _Mail:
        return _Mail(
