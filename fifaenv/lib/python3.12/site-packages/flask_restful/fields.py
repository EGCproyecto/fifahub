...
class List(Raw):
    ...
    def __init__(self, cls_or_instance, **kwargs):
        ...
        error_msg = "The type of the list elements must be a subclass of " "flask_restful.fields.Raw"
    ...
    def format(self, value):
        ...
        return [
            self.container.output(
                ...
                (
                    val
                    if (isinstance(val, dict) or (self.container.attribute and hasattr(val, self.container.attribute)))
