...
class FileSystemCache(BaseCache):
    ...
    def _update_count(self, delta: _t.Optional[int] = None, value: _t.Optional[int] = None) -> None:
    ...
    def _list_dir(self) -> _t.Generator[str, None, None]:
        ...
        return (os.path.join(self._path, fn) for fn in os.listdir(self._path) if not self._is_mgmt(fn))
    ...
    def _remove_older(self) -> bool:
        ...
        fname_sorted = (fname for _, fname in sorted(exp_fname_tuples, key=lambda item: item[0]))
