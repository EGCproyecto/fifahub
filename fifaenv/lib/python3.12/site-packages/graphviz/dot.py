...
class Dot(quoting.Quote, base.Base):
    ...
    @_tools.deprecate_positional_args(supported_number=2, ignore_arg="self", category=DeprecationWarning)
    ...
    @_tools.deprecate_positional_args(supported_number=3, ignore_arg="self", category=DeprecationWarning)
    def edge(
    ...
    @_tools.deprecate_positional_args(supported_number=1, ignore_arg="self", category=DeprecationWarning)
