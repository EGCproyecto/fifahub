...
class _TargetInvalid(Invalid):
    ...
    def __str__(self):
        return "{} {}{}{}{}".format(
            self._str_subject, self._str_description, self._str_conjunction, self._str_details, self._str_trailer
        )
...
class MultipleInvalid(_TargetInvalid):
    ...
    def _str_details(self):
        ...
        return "\n    " + "\n    ".join(
            x._str_details.strip() if isinstance(x, _TargetInvalid) else str(x) for x in self.exceptions
        )
