...
from zope.interface.tests import MissingSomeAttrs, OptimizationTestMixin, SubclassableMixin
...
class TestProvidesClassRepr(unittest.TestCase):
    ...
    def test__repr__module_provides_typical_use(self):
        ...
        self.assertEqual(
            repr(provides), "directlyProvides(" "sys.modules['zope.interface.tests.dummy'], " "IDummyModule)"
        )
    ...
    def test__repr__directlyProvides_module(self):
        ...
        self.assertEqual(
            repr(provides), "directlyProvides(" "sys.modules['zope.interface.tests.dummy'], " "IFoo, IBar)"
        )
...
class ClassProvidesStrictTests(ClassProvidesTests):
    ...
    def test_overlapping_interfaces_corrected(self):
        ...
        self.assertEqual(
            spec.__sro__, (spec, implementedBy(metaclass), IBase, implementedBy(type), implementedBy(object), Interface)
        )
