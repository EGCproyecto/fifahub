...
class ComponentsTests(unittest.TestCase):
    ...
    def test_registerUtility_w_different_info(self):
        ...
        self.assertEqual(comp._utility_registrations[(ifoo, _name)], (_to_reg, _info2, None))  # replaced
        self.assertEqual(comp.utilities._subscribers[0][ifoo][""], (_to_reg,))
    ...
    def test_registerAdapter_no_required_available(self):
        ...
        comp = self._makeOne()
        self.assertRaises(TypeError, comp.registerAdapter, _Factory, provided=ifoo, name=_name, info=_info)
    ...
    def test_registerAdapter_w_required_containing_class(self):
        from zope.interface.declarations import InterfaceClass, implementedBy, implementer
        from zope.interface.interfaces import Registered
        from zope.interface.registry import AdapterRegistration
    ...
    def test_unregisterAdapter_neither_factory_nor_required(self):
        ...
        ifoo = IFoo("IFoo")
        comp = self._makeOne()
        self.assertRaises(TypeError, comp.unregisterAdapter, factory=None, provided=ifoo, required=None)
    ...
    def test_queryMultiAdapter_miss_w_default(self):
        ...
        _default = object()
        comp = self._makeOne()
        self.assertIs(comp.queryMultiAdapter((_context1, _context2), ifoo, default=_default), _default)
    ...
    def test_getMultiAdapter_miss(self):
        ...
        _context2 = _Context2()
        comp = self._makeOne()
        self.assertRaises(ComponentLookupError, comp.getMultiAdapter, (_context1, _context2), ifoo)
    ...
    def test_unregisterHandler_w_nonblank_name(self):
        ...
        _nonblank = "nonblank"
        comp = self._makeOne()
        self.assertRaises(TypeError, comp.unregisterHandler, required=(ifoo,), name=_nonblank)
