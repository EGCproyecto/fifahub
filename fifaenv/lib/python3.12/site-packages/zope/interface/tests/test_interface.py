...
from zope.interface.tests import CleanUp, MissingSomeAttrs, OptimizationTestMixin, SubclassableMixin
...
class InterfaceClassTests(unittest.TestCase):
    ...
    def _makeOne(self, name="ITest", bases=(), attrs=None, __doc__=None, __module__=None):
...
class InterfaceTests(unittest.TestCase):
    ...
    def test_invariant_nested(self):
        ...
        has_invariant.bar = 0
        self._errorsEqual(
            has_invariant, 2, ["If Foo, then Bar!", "Please, Boo MUST be greater than Foo!"], ISubInvariant
        )
