    ...
    def test_asStructuredText_empty_with_multiline_docstring(self):
        ...
        EXPECTED = "\n".join(
            [
                ...
                " This is an empty interface.",
                " ",
                (f"{indent} It can be used to annotate any class or object, " "because it promises"),  # noqa E127
                f"{indent} nothing.",
                "",
                " Attributes:",
                "",
    ...
    def test_asReStructuredText_empty_with_multiline_docstring(self):
        ...
        EXPECTED = "\n".join(
            [
                ...
                " This is an empty interface.",
                " ",
                (f"{indent} It can be used to annotate any class or object, " f"because it"),  # noqa E124
