...
from ._dup import DROP_NEW, DROP_OLD, ON_DUP_DEFAULT, RAISE, OnDup
from ._exc import DuplicationError, KeyAndValueDuplicationError, KeyDuplicationError, ValueDuplicationError
from ._iter import inverted, iteritems
from ._typing import KT, MISSING, OKT, OVT, VT, Maplike, MapOrItems
