...
class Field(DslBase):
    ...
    def __init__(self, multi: bool = False, required: bool = False, *args: Any, **kwargs: Any):
        """
    ...
    def deserialize(self, data: Any) -> Any:
        if isinstance(data, (list, AttrList, tuple)):
            data = [None if d is None else self._deserialize(d) for d in cast(Iterable[Any], data)]
            return data
        if data is None:
            return None
...
class Float(Field):
    ...
    def __init__(
        ...
        *args: Any,
        ...
        dynamic: Union[Literal["strict", "runtime", "true", "false"], bool, "DefaultType"] = DEFAULT,
        fields: Union[Mapping[str, Field], "DefaultType"] = DEFAULT,
        synthetic_source_keep: Union[Literal["none", "arrays", "all"], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
...
class Object(Field):
    ...
    def __init__(
        ...
        *args: Any,
        ...
        subobjects: Union[Literal["true", "false", "auto"], bool, "DefaultType"] = DEFAULT,
        copy_to: Union[
            Union[str, "InstrumentedField"],
            Sequence[Union[str, "InstrumentedField"]],
            "DefaultType",
    ...
    def _serialize(self, data: Optional[Union[Dict[str, Any], "InnerDoc"]]) -> Optional[Dict[str, Any]]:
        if data is None:
            return None
...
class Boolean(Field):
    ...
    def __init__(
        ...
        *args: Any,
        boost: Union[float, "DefaultType"] = DEFAULT,
        fielddata: Union["types.NumericFielddata", Dict[str, Any], "DefaultType"] = DEFAULT,
        index: Union[bool, "DefaultType"] = DEFAULT,
...
class Completion(Field):
    ...
    def __init__(
        ...
        *args: Any,
        ...
        contexts: Union[Sequence["types.SuggestContext"], Sequence[Dict[str, Any]], "DefaultType"] = DEFAULT,
    ...
    def _deserialize(self, data: Any) -> Union[datetime, date]:
        if isinstance(data, str):
            try:
                ...
                raise ValidationException(f"Could not parse date from the value ({data!r})", e)
...
class DenseVector(Field):
    ...
    def __init__(
        ...
        *args: Any,
        ...
        index: Union[bool, "DefaultType"] = DEFAULT,
        index_options: Union["types.DenseVectorIndexOptions", Dict[str, Any], "DefaultType"] = DEFAULT,
        similarity: Union[
...
class Flattened(Field):
    ...
    def __init__(
        ...
        *args: Any,
        ...
        index: Union[bool, "DefaultType"] = DEFAULT,
        index_options: Union[Literal["docs", "freqs", "positions", "offsets"], "DefaultType"] = DEFAULT,
...
class Join(Field):
    ...
    def __init__(
        self,
        *args: Any,
        relations: Union[Mapping[str, Union[str, Sequence[str]]], "DefaultType"] = DEFAULT,
        eager_global_ordinals: Union[bool, "DefaultType"] = DEFAULT,
        meta: Union[Mapping[str, str], "DefaultType"] = DEFAULT,
        properties: Union[Mapping[str, Field], "DefaultType"] = DEFAULT,
        ignore_above: Union[int, "DefaultType"] = DEFAULT,
...
class Text(Field):
    ...
    def __init__(
        ...
        *args: Any,
        ...
        fielddata_frequency_filter: Union["types.FielddataFrequencyFilter", Dict[str, Any], "DefaultType"] = DEFAULT,
        index: Union[bool, "DefaultType"] = DEFAULT,
        index_options: Union[Literal["docs", "freqs", "positions", "offsets"], "DefaultType"] = DEFAULT,
        index_phrases: Union[bool, "DefaultType"] = DEFAULT,
        index_prefixes: Union["types.TextIndexPrefixes", None, Dict[str, Any], "DefaultType"] = DEFAULT,
        norms: Union[bool, "DefaultType"] = DEFAULT,
