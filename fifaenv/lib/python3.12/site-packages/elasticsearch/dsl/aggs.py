...
def A(
    ...
    **params: Any,
    ...
    if isinstance(name_or_agg, collections.abc.MutableMapping):
        ...
        if len(agg) != 1:
            raise ValueError(
                'A() can only accept dict with an aggregation ({"terms": {...}}). ' "Instead it got (%r)" % name_or_agg
            )
...
class AggBase(Generic[_R]):
    ...
    def __getitem__(self, agg_name: str) -> Agg[_R]:
        agg = cast(Agg[_R], self._params.setdefault("aggs", {})[agg_name])  # propagate KeyError
...
class AutoDateHistogram(Bucket[_R]):
    ...
    def __init__(
        ...
        *,
        ...
        minimum_interval: Union[Literal["second", "minute", "hour", "day", "month", "year"], "DefaultType"] = DEFAULT,
        missing: Any = DEFAULT,
...
class Avg(Agg[_R]):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(format=format, field=field, missing=missing, script=script, **kwargs)
...
class AvgBucket(Pipeline[_R]):
    ...
    def __init__(
        ...
        *,
        format: Union[str, "DefaultType"] = DEFAULT,
        gap_policy: Union[Literal["skip", "insert_zeros", "keep_values"], "DefaultType"] = DEFAULT,
        buckets_path: Union[str, Sequence[str], Mapping[str, str], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
        super().__init__(format=format, gap_policy=gap_policy, buckets_path=buckets_path, **kwargs)
...
class BucketSort(Bucket[_R]):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(from_=from_, gap_policy=gap_policy, size=size, sort=sort, **kwargs)
...
class BucketCorrelation(Pipeline[_R]):
    ...
    def __init__(
        self,
        *,
        function: Union["types.BucketCorrelationFunction", Dict[str, Any], "DefaultType"] = DEFAULT,
        buckets_path: Union[str, Sequence[str], Mapping[str, str], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
...
class Composite(Bucket[_R]):
    ...
    def __init__(
        ...
        *,
        after: Union[
            Mapping[Union[str, "InstrumentedField"], Union[int, float, str, bool, None, Any]],
            "DefaultType",
        ] = DEFAULT,
        size: Union[int, "DefaultType"] = DEFAULT,
...
class DateHistogram(Bucket[_R]):
    ...
    def __init__(
        ...
        *,
        ...
        extended_bounds: Union["types.ExtendedBounds", Dict[str, Any], "DefaultType"] = DEFAULT,
        hard_bounds: Union["types.ExtendedBounds", Dict[str, Any], "DefaultType"] = DEFAULT,
        field: Union[str, "InstrumentedField", "DefaultType"] = DEFAULT,
...
class DiversifiedSampler(Bucket[_R]):
    ...
    def __init__(
        self,
        *,
        execution_hint: Union[Literal["map", "global_ordinals", "bytes_hash"], "DefaultType"] = DEFAULT,
...
class GeoDistance(Bucket[_R]):
    ...
    def __init__(
        ...
        *,
        ...
        ranges: Union[Sequence["types.AggregationRange"], Sequence[Dict[str, Any]], "DefaultType"] = DEFAULT,
...
class Inference(Pipeline[_R]):
    ...
    def __init__(
        ...
        *,
        ...
        inference_config: Union["types.InferenceConfigContainer", Dict[str, Any], "DefaultType"] = DEFAULT,
        format: Union[str, "DefaultType"] = DEFAULT,
        gap_policy: Union[Literal["skip", "insert_zeros", "keep_values"], "DefaultType"] = DEFAULT,
        buckets_path: Union[str, Sequence[str], Mapping[str, str], "DefaultType"] = DEFAULT,
        **kwargs: Any,
...
class MatrixStats(Agg[_R]):
    ...
    def __init__(
        ...
        *,
        ...
        missing: Union[Mapping[Union[str, "InstrumentedField"], float], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
...
class EwmaMovingAverageAggregation(MovingAvg[_R]):
    ...
    def __init__(
        ...
        *,
        model: Any = DEFAULT,
        settings: Union["types.EwmaModelSettings", Dict[str, Any], "DefaultType"] = DEFAULT,
        minimize: Union[bool, "DefaultType"] = DEFAULT,
        predict: Union[int, "DefaultType"] = DEFAULT,
        window: Union[int, "DefaultType"] = DEFAULT,
        format: Union[str, "DefaultType"] = DEFAULT,
...
class HoltMovingAverageAggregation(MovingAvg[_R]):
    ...
    def __init__(
        ...
        *,
        model: Any = DEFAULT,
        settings: Union["types.HoltLinearModelSettings", Dict[str, Any], "DefaultType"] = DEFAULT,
        minimize: Union[bool, "DefaultType"] = DEFAULT,
        predict: Union[int, "DefaultType"] = DEFAULT,
        window: Union[int, "DefaultType"] = DEFAULT,
        format: Union[str, "DefaultType"] = DEFAULT,
...
class HoltWintersMovingAverageAggregation(MovingAvg[_R]):
    ...
    def __init__(
        ...
        *,
        model: Any = DEFAULT,
        settings: Union["types.HoltWintersModelSettings", Dict[str, Any], "DefaultType"] = DEFAULT,
        minimize: Union[bool, "DefaultType"] = DEFAULT,
        predict: Union[int, "DefaultType"] = DEFAULT,
        window: Union[int, "DefaultType"] = DEFAULT,
        format: Union[str, "DefaultType"] = DEFAULT,
...
class MultiTerms(Bucket[_R]):
    ...
    def __init__(
        self,
        *,
        terms: Union[Sequence["types.MultiTermLookup"], Sequence[Dict[str, Any]], "DefaultType"] = DEFAULT,
        collect_mode: Union[Literal["depth_first", "breadth_first"], "DefaultType"] = DEFAULT,
        order: Union[
            Mapping[Union[str, "InstrumentedField"], Literal["asc", "desc"]],
            Sequence[Mapping[Union[str, "InstrumentedField"], Literal["asc", "desc"]]],
            "DefaultType",
...
class RareTerms(Bucket[_R]):
    ...
    def __init__(
        ...
        *,
        ...
        field: Union[str, "InstrumentedField", "DefaultType"] = DEFAULT,
        include: Union[str, Sequence[str], "types.TermsPartition", Dict[str, Any], "DefaultType"] = DEFAULT,
...
class RandomSampler(Bucket[_R]):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(probability=probability, seed=seed, shard_seed=shard_seed, **kwargs)
...
class SignificantTerms(Bucket[_R]):
    ...
    def __init__(
        ...
        *,
        ...
        chi_square: Union["types.ChiSquareHeuristic", Dict[str, Any], "DefaultType"] = DEFAULT,
        exclude: Union[str, Sequence[str], "DefaultType"] = DEFAULT,
        execution_hint: Union[
            Literal[
                "map",
        ...
        field: Union[str, "InstrumentedField", "DefaultType"] = DEFAULT,
        gnd: Union["types.GoogleNormalizedDistanceHeuristic", Dict[str, Any], "DefaultType"] = DEFAULT,
        include: Union[str, Sequence[str], "types.TermsPartition", Dict[str, Any], "DefaultType"] = DEFAULT,
        jlh: Union["types.EmptyObject", Dict[str, Any], "DefaultType"] = DEFAULT,
        min_doc_count: Union[int, "DefaultType"] = DEFAULT,
        mutual_information: Union["types.MutualInformationHeuristic", Dict[str, Any], "DefaultType"] = DEFAULT,
        percentage: Union["types.PercentageScoreHeuristic", Dict[str, Any], "DefaultType"] = DEFAULT,
        script_heuristic: Union["types.ScriptedHeuristic", Dict[str, Any], "DefaultType"] = DEFAULT,
        shard_min_doc_count: Union[int, "DefaultType"] = DEFAULT,
        shard_size: Union[int, "DefaultType"] = DEFAULT,
        size: Union[int, "DefaultType"] = DEFAULT,
        **kwargs: Any,
...
class Terms(Bucket[_R]):
    ...
    def __init__(
        ...
        *,
        ...
        min_doc_count: Union[int, "DefaultType"] = DEFAULT,
        missing: Union[str, int, float, bool, "DefaultType"] = DEFAULT,
        missing_order: Union[Literal["first", "last", "default"], "DefaultType"] = DEFAULT,
...
class TopHits(Agg[_R]):
    ...
    def __init__(
        self,
        *,
        docvalue_fields: Union[Sequence["types.FieldAndFormat"], Sequence[Dict[str, Any]], "DefaultType"] = DEFAULT,
        explain: Union[bool, "DefaultType"] = DEFAULT,
        fields: Union[Sequence["types.FieldAndFormat"], Sequence[Dict[str, Any]], "DefaultType"] = DEFAULT,
        from_: Union[int, "DefaultType"] = DEFAULT,
        highlight: Union["types.Highlight", Dict[str, Any], "DefaultType"] = DEFAULT,
        script_fields: Union[Mapping[str, "types.ScriptField"], Dict[str, Any], "DefaultType"] = DEFAULT,
        size: Union[int, "DefaultType"] = DEFAULT,
        sort: Union[
            Union[Union[str, "InstrumentedField"], "types.SortOptions"],
            Sequence[Union[Union[str, "InstrumentedField"], "types.SortOptions"]],
        ...
        _source: Union[bool, "types.SourceFilter", Dict[str, Any], "DefaultType"] = DEFAULT,
        stored_fields: Union[
            Union[str, "InstrumentedField"],
            Sequence[Union[str, "InstrumentedField"]],
            "DefaultType",
...
class TTest(Agg[_R]):
    ...
    def __init__(
        ...
        *,
        ...
        type: Union[Literal["paired", "homoscedastic", "heteroscedastic"], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
...
class WeightedAvg(Agg[_R]):
    ...
    def __init__(
        ...
        *,
        format: Union[str, "DefaultType"] = DEFAULT,
        value: Union["types.WeightedAverageValue", Dict[str, Any], "DefaultType"] = DEFAULT,
        value_type: Union[
            Literal[
                "string",
                "long",
        ...
        weight: Union["types.WeightedAverageValue", Dict[str, Any], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
        super().__init__(format=format, value=value, value_type=value_type, weight=weight, **kwargs)
