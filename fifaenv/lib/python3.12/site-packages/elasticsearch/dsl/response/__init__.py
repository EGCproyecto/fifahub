...
class Response(AttrDict[Any], Generic[_R]):
    ...
    suggest: Mapping[
        str,
        Sequence[Union["types.CompletionSuggest", "types.PhraseSuggest", "types.TermSuggest"]],
    ]
    ...
    def __setstate__(self, state: Tuple[Dict[str, Any], "Request[_R]", Optional[_R]]) -> None:  # type: ignore[override]
