...
class Mapping(MappingBase):
    @classmethod
    def from_es(cls, index: Optional[Union[str, List[str]]], using: UsingType = "default") -> Self:
        m = cls()
        m.update_from_es(index, using)
        return m

    def update_from_es(self, index: Optional[Union[str, List[str]]], using: UsingType = "default") -> None:
