        ...
        if isinstance(other, Bool):
            ...
            for qx in (self, other):
                ...
                if not isinstance(min_should_match, int) or min_should_match < 0:
                    raise ValueError("Can only combine queries with positive integer values for minimum_should_match")
...
class Common(Query):
    ...
    def __init__(
        ...
        _value: Union["types.CommonTermsQuery", Dict[str, Any], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
...
class DisMax(Query):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(queries=queries, tie_breaker=tie_breaker, boost=boost, _name=_name, **kwargs)
...
class DistanceFeature(Query):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(origin=origin, pivot=pivot, field=field, boost=boost, _name=_name, **kwargs)
...
class FunctionScore(Query):
    ...
    def __init__(
        self,
        *,
        boost_mode: Union[Literal["multiply", "replace", "sum", "avg", "max", "min"], "DefaultType"] = DEFAULT,
        ...
        score_mode: Union[Literal["multiply", "sum", "avg", "first", "max", "min"], "DefaultType"] = DEFAULT,
        boost: Union[float, "DefaultType"] = DEFAULT,
        _name: Union[str, "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
...
class GeoBoundingBox(Query):
    ...
    def __init__(
        ...
        *,
        ...
        validation_method: Union[Literal["coerce", "ignore_malformed", "strict"], "DefaultType"] = DEFAULT,
...
class GeoPolygon(Query):
    ...
    def __init__(
        self,
        _field: Union[str, "InstrumentedField", "DefaultType"] = DEFAULT,
        _value: Union["types.GeoPolygonPoints", Dict[str, Any], "DefaultType"] = DEFAULT,
        *,
        validation_method: Union[Literal["coerce", "ignore_malformed", "strict"], "DefaultType"] = DEFAULT,
        ignore_unmapped: Union[bool, "DefaultType"] = DEFAULT,
        boost: Union[float, "DefaultType"] = DEFAULT,
...
class GeoShape(Query):
    ...
    def __init__(
        self,
        _field: Union[str, "InstrumentedField", "DefaultType"] = DEFAULT,
        _value: Union["types.GeoShapeFieldQuery", Dict[str, Any], "DefaultType"] = DEFAULT,
        *,
        ignore_unmapped: Union[bool, "DefaultType"] = DEFAULT,
        boost: Union[float, "DefaultType"] = DEFAULT,
        _name: Union[str, "DefaultType"] = DEFAULT,
        **kwargs: Any,
        ...
        if _field is not DEFAULT:
            kwargs[str(_field)] = _value
        super().__init__(ignore_unmapped=ignore_unmapped, boost=boost, _name=_name, **kwargs)
...
class HasChild(Query):
    ...
    def __init__(
        ...
        *,
        ...
        score_mode: Union[Literal["none", "avg", "sum", "max", "min"], "DefaultType"] = DEFAULT,
        boost: Union[float, "DefaultType"] = DEFAULT,
        _name: Union[str, "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
...
class Knn(Query):
    ...
    def __init__(
        ...
        *,
        ...
        query_vector_builder: Union["types.QueryVectorBuilder", Dict[str, Any], "DefaultType"] = DEFAULT,
        num_candidates: Union[int, "DefaultType"] = DEFAULT,
        k: Union[int, "DefaultType"] = DEFAULT,
        filter: Union[Query, Sequence[Query], "DefaultType"] = DEFAULT,
        similarity: Union[float, "DefaultType"] = DEFAULT,
        rescore_vector: Union["types.RescoreVector", Dict[str, Any], "DefaultType"] = DEFAULT,
        boost: Union[float, "DefaultType"] = DEFAULT,
        _name: Union[str, "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
...
class MatchBoolPrefix(Query):
    ...
    def __init__(
        self,
        _field: Union[str, "InstrumentedField", "DefaultType"] = DEFAULT,
        _value: Union["types.MatchBoolPrefixQuery", Dict[str, Any], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
        if _field is not DEFAULT:
            kwargs[str(_field)] = _value
...
class MatchPhrase(Query):
    ...
    def __init__(
        self,
        _field: Union[str, "InstrumentedField", "DefaultType"] = DEFAULT,
        _value: Union["types.MatchPhraseQuery", Dict[str, Any], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
        if _field is not DEFAULT:
            kwargs[str(_field)] = _value
...
class MatchPhrasePrefix(Query):
    ...
    def __init__(
        self,
        _field: Union[str, "InstrumentedField", "DefaultType"] = DEFAULT,
        _value: Union["types.MatchPhrasePrefixQuery", Dict[str, Any], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
        if _field is not DEFAULT:
            kwargs[str(_field)] = _value
...
class Pinned(Query):
    ...
    def __init__(
        ...
        *,
        ...
        docs: Union[Sequence["types.PinnedDoc"], Sequence[Dict[str, Any]], "DefaultType"] = DEFAULT,
        boost: Union[float, "DefaultType"] = DEFAULT,
        _name: Union[str, "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
        super().__init__(organic=organic, ids=ids, docs=docs, boost=boost, _name=_name, **kwargs)
...
class RankFeature(Query):
    ...
    def __init__(
        ...
        *,
        field: Union[str, "InstrumentedField", "DefaultType"] = DEFAULT,
        saturation: Union["types.RankFeatureFunctionSaturation", Dict[str, Any], "DefaultType"] = DEFAULT,
        log: Union["types.RankFeatureFunctionLogarithm", Dict[str, Any], "DefaultType"] = DEFAULT,
        linear: Union["types.RankFeatureFunctionLinear", Dict[str, Any], "DefaultType"] = DEFAULT,
        sigmoid: Union["types.RankFeatureFunctionSigmoid", Dict[str, Any], "DefaultType"] = DEFAULT,
        boost: Union[float, "DefaultType"] = DEFAULT,
        _name: Union[str, "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
...
class SimpleQueryString(Query):
    ...
    def __init__(
        ...
        *,
        ...
        default_operator: Union[Literal["and", "or"], "DefaultType"] = DEFAULT,
        fields: Union[Sequence[Union[str, "InstrumentedField"]], "DefaultType"] = DEFAULT,
        flags: Union["types.PipeSeparatedFlags", Dict[str, Any], "DefaultType"] = DEFAULT,
        fuzzy_max_expansions: Union[int, "DefaultType"] = DEFAULT,
        fuzzy_prefix_length: Union[int, "DefaultType"] = DEFAULT,
        fuzzy_transpositions: Union[bool, "DefaultType"] = DEFAULT,
        lenient: Union[bool, "DefaultType"] = DEFAULT,
...
class SpanNear(Query):
    ...
    def __init__(
        self,
        *,
        clauses: Union[Sequence["types.SpanQuery"], Sequence[Dict[str, Any]], "DefaultType"] = DEFAULT,
...
class SparseVector(Query):
    ...
    def __init__(
        ...
        *,
        ...
        pruning_config: Union["types.TokenPruningConfig", Dict[str, Any], "DefaultType"] = DEFAULT,
        boost: Union[float, "DefaultType"] = DEFAULT,
        _name: Union[str, "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
...
class TextExpansion(Query):
    ...
    def __init__(
        self,
        _field: Union[str, "InstrumentedField", "DefaultType"] = DEFAULT,
        _value: Union["types.TextExpansionQuery", Dict[str, Any], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
        if _field is not DEFAULT:
            kwargs[str(_field)] = _value
...
class WeightedTokens(Query):
    ...
    def __init__(
        self,
        _field: Union[str, "InstrumentedField", "DefaultType"] = DEFAULT,
        _value: Union["types.WeightedTokensQuery", Dict[str, Any], "DefaultType"] = DEFAULT,
        **kwargs: Any,
    ):
        if _field is not DEFAULT:
            kwargs[str(_field)] = _value
