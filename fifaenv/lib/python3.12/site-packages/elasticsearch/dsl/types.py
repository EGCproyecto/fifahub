...
class BucketCorrelationFunction(AttrDict[Any]):
    ...
    count_correlation: Union["BucketCorrelationFunctionCountCorrelation", Dict[str, Any], DefaultType]

    def __init__(
        self,
        *,
        count_correlation: Union["BucketCorrelationFunctionCountCorrelation", Dict[str, Any], DefaultType] = DEFAULT,
        **kwargs: Any,
    ):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if num_top_feature_importance_values is not DEFAULT:
            kwargs["num_top_feature_importance_values"] = num_top_feature_importance_values
...
class FieldCollapse(AttrDict[Any]):
    ...
    field: Union[str, InstrumentedField, DefaultType]
    inner_hits: Union["InnerHits", Sequence["InnerHits"], Sequence[Dict[str, Any]], DefaultType]
    ...
    def __init__(
        ...
        *,
        field: Union[str, InstrumentedField, DefaultType] = DEFAULT,
        inner_hits: Union["InnerHits", Sequence["InnerHits"], Sequence[Dict[str, Any]], DefaultType] = DEFAULT,
...
class FieldSort(AttrDict[Any]):
    ...
    def __init__(
        ...
        *,
        ...
        mode: Union[Literal["min", "max", "sum", "avg", "median"], DefaultType] = DEFAULT,
        ...
        numeric_type: Union[Literal["long", "double", "date", "date_nanos"], DefaultType] = DEFAULT,
        format: Union[str, DefaultType] = DEFAULT,
        **kwargs: Any,
    ):
...
class FrequentItemSetsField(AttrDict[Any]):
    ...
    def __init__(
        ...
        *,
        ...
        include: Union[str, Sequence[str], "TermsPartition", Dict[str, Any], DefaultType] = DEFAULT,
        **kwargs: Any,
    ):
        if field is not DEFAULT:
            kwargs["field"] = str(field)
...
class GeoDistanceSort(AttrDict[Any]):
    ...
    order: Union[Literal["asc", "desc"], DefaultType]
    unit: Union[Literal["in", "ft", "yd", "mi", "nmi", "km", "m", "cm", "mm"], DefaultType]
    nested: Union["NestedSortValue", Dict[str, Any], DefaultType]
    ...
    def __init__(
        ...
        *,
        ...
        order: Union[Literal["asc", "desc"], DefaultType] = DEFAULT,
        unit: Union[Literal["in", "ft", "yd", "mi", "nmi", "km", "m", "cm", "mm"], DefaultType] = DEFAULT,
        nested: Union["NestedSortValue", Dict[str, Any], DefaultType] = DEFAULT,
        **kwargs: Any,
    ):
...
class GeoShapeFieldQuery(AttrDict[Any]):
    ...
    relation: Union[Literal["intersects", "disjoint", "within", "contains"], DefaultType]
    ...
    def __init__(
        ...
        *,
        ...
        relation: Union[Literal["intersects", "disjoint", "within", "contains"], DefaultType] = DEFAULT,
        **kwargs: Any,
    ):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if number_of_significant_value_digits is not DEFAULT:
            kwargs["number_of_significant_value_digits"] = number_of_significant_value_digits
        super().__init__(kwargs)
...
class Highlight(AttrDict[Any]):
    ...
    def __init__(
        ...
        *,
        ...
        boundary_scanner: Union[Literal["chars", "sentence", "word"], DefaultType] = DEFAULT,
...
class InferenceConfigContainer(AttrDict[Any]):
    ...
    def __init__(
        self,
        *,
        regression: Union["RegressionInferenceOptions", Dict[str, Any], DefaultType] = DEFAULT,
        classification: Union["ClassificationInferenceOptions", Dict[str, Any], DefaultType] = DEFAULT,
        **kwargs: Any,
    ):
...
class InnerHits(AttrDict[Any]):
    ...
    collapse: Union["FieldCollapse", Dict[str, Any], DefaultType]
    docvalue_fields: Union[Sequence["FieldAndFormat"], Sequence[Dict[str, Any]], DefaultType]
    ...
    def __init__(
        ...
        *,
        ...
        collapse: Union["FieldCollapse", Dict[str, Any], DefaultType] = DEFAULT,
        docvalue_fields: Union[Sequence["FieldAndFormat"], Sequence[Dict[str, Any]], DefaultType] = DEFAULT,
...
class IntervalsAllOf(AttrDict[Any]):
    ...
    intervals: Union[Sequence["IntervalsContainer"], Sequence[Dict[str, Any]], DefaultType]
    ...
    def __init__(
        self,
        *,
        intervals: Union[Sequence["IntervalsContainer"], Sequence[Dict[str, Any]], DefaultType] = DEFAULT,
...
class IntervalsFilter(AttrDict[Any]):
    ...
    def __init__(
        ...
        *,
        ...
        contained_by: Union["IntervalsContainer", Dict[str, Any], DefaultType] = DEFAULT,
        containing: Union["IntervalsContainer", Dict[str, Any], DefaultType] = DEFAULT,
        not_contained_by: Union["IntervalsContainer", Dict[str, Any], DefaultType] = DEFAULT,
        not_containing: Union["IntervalsContainer", Dict[str, Any], DefaultType] = DEFAULT,
        not_overlapping: Union["IntervalsContainer", Dict[str, Any], DefaultType] = DEFAULT,
...
class LikeDocument(AttrDict[Any]):
    ...
    version_type: Union[Literal["internal", "external", "external_gte", "force"], DefaultType]
    ...
    def __init__(
        ...
        *,
        ...
        per_field_analyzer: Union[Mapping[Union[str, InstrumentedField], str], DefaultType] = DEFAULT,
        routing: Union[str, DefaultType] = DEFAULT,
        version: Union[int, DefaultType] = DEFAULT,
        version_type: Union[Literal["internal", "external", "external_gte", "force"], DefaultType] = DEFAULT,
        **kwargs: Any,
    ):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if auto_generate_synonyms_phrase_query is not DEFAULT:
            kwargs["auto_generate_synonyms_phrase_query"] = auto_generate_synonyms_phrase_query
        if cutoff_frequency is not DEFAULT:
            kwargs["cutoff_frequency"] = cutoff_frequency
        if fuzziness is not DEFAULT:
            kwargs["fuzziness"] = fuzziness
...
class RankFeatureFunctionLogarithm(AttrDict[Any]):
    ...
    def __init__(self, *, scaling_factor: Union[float, DefaultType] = DEFAULT, **kwargs: Any):
...
class RescoreVector(AttrDict[Any]):
    ...
    def __init__(self, *, oversample: Union[float, DefaultType] = DEFAULT, **kwargs: Any):
...
class Script(AttrDict[Any]):
    ...
    def __init__(
        ...
        *,
        ...
        lang: Union[Literal["painless", "expression", "mustache", "java"], DefaultType] = DEFAULT,
...
class SpanNearQuery(AttrDict[Any]):
    ...
    def __init__(
        self,
        *,
        clauses: Union[Sequence["SpanQuery"], Sequence[Dict[str, Any]], DefaultType] = DEFAULT,
...
class SpanQuery(AttrDict[Any]):
    ...
    def __init__(
        self,
        *,
        span_containing: Union["SpanContainingQuery", Dict[str, Any], DefaultType] = DEFAULT,
        span_field_masking: Union["SpanFieldMaskingQuery", Dict[str, Any], DefaultType] = DEFAULT,
        span_first: Union["SpanFirstQuery", Dict[str, Any], DefaultType] = DEFAULT,
        span_gap: Union[Mapping[Union[str, InstrumentedField], int], DefaultType] = DEFAULT,
...
class TDigest(AttrDict[Any]):
    ...
    def __init__(self, *, compression: Union[int, DefaultType] = DEFAULT, **kwargs: Any):
...
class TermsSetQuery(AttrDict[Any]):
    ...
    def __init__(
        ...
        *,
        ...
        minimum_should_match: Union[int, str, DefaultType] = DEFAULT,
        minimum_should_match_field: Union[str, InstrumentedField, DefaultType] = DEFAULT,
        minimum_should_match_script: Union["Script", Dict[str, Any], DefaultType] = DEFAULT,
        boost: Union[float, DefaultType] = DEFAULT,
        _name: Union[str, DefaultType] = DEFAULT,
        **kwargs: Any,
    ):
...
class TextExpansionQuery(AttrDict[Any]):
    ...
    def __init__(
        ...
        *,
        model_id: Union[str, DefaultType] = DEFAULT,
        model_text: Union[str, DefaultType] = DEFAULT,
        pruning_config: Union["TokenPruningConfig", Dict[str, Any], DefaultType] = DEFAULT,
        boost: Union[float, DefaultType] = DEFAULT,
        _name: Union[str, DefaultType] = DEFAULT,
        **kwargs: Any,
    ):
...
class CompletionSuggestOption(AttrDict[Any]):
    ...
    contexts: Mapping[
        str,
        Sequence[Union[str, Union["LatLonGeoLocation", "GeoHashLocation", Sequence[float], str]]],
    ]
...
class Hit(AttrDict[Any]):
    ...
    ignored_field_values: Mapping[str, Sequence[Union[int, float, str, bool, None, Any]]]
    shard: str
    node: str
    routing: str
    source: Any
