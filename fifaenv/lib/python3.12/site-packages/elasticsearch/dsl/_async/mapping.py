...
class AsyncMapping(MappingBase):
    @classmethod
    async def from_es(cls, index: Optional[Union[str, List[str]]], using: AsyncUsingType = "default") -> Self:
        m = cls()
        await m.update_from_es(index, using)
        return m

    async def update_from_es(self, index: Optional[Union[str, List[str]]], using: AsyncUsingType = "default") -> None:
