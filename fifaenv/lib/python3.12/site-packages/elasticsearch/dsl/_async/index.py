...
class AsyncIndexTemplate:
    def __init__(
        ...
        **kwargs: Any,
        ...
        if index is None:
            ...
            if kwargs:
                raise ValueError("You cannot specify options for Index when" " passing an Index instance.")
    ...
    async def save(self, using: Optional[AsyncUsingType] = None) -> "ObjectApiResponse[Any]":
        es = get_connection(using or self._index._using)
        return await es.indices.put_template(name=self._template_name, body=self.to_dict())
...
class AsyncComposableIndexTemplate:
    ...
    async def save(self, using: Optional[AsyncUsingType] = None) -> "ObjectApiResponse[Any]":
        es = get_connection(using or self._index._using)
        return await es.indices.put_index_template(name=self._template_name, **self.to_dict())
...
class AsyncIndex(IndexBase):
    ...
    def _get_connection(self, using: Optional[AsyncUsingType] = None) -> "AsyncElasticsearch":
    ...
    def as_composable_template(
        ...
        return AsyncComposableIndexTemplate(template_name, pattern or self._name, index=self, priority=priority)

    async def load_mappings(self, using: Optional[AsyncUsingType] = None) -> None:
        await self.get_or_create_mapping().update_from_es(self._name, using=using or self._using)

    def clone(self, name: Optional[str] = None, using: Optional[AsyncUsingType] = None) -> Self:
        """
    ...
    def updateByQuery(self, using: Optional[AsyncUsingType] = None) -> AsyncUpdateByQuery:
        """
    ...
    async def create(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
        ...
        """
        return await self._get_connection(using).indices.create(index=self._name, body=self.to_dict(), **kwargs)
    ...
    async def save(self, using: Optional[AsyncUsingType] = None) -> "Optional[ObjectApiResponse[Any]]":
        """
    ...
    async def analyze(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def refresh(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def flush(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def get(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def open(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def close(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def delete(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def exists(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> bool:
        """
        ...
        """
        return bool(await self._get_connection(using).indices.exists(index=self._name, **kwargs))

    async def put_mapping(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
        ...
        """
        return await self._get_connection(using).indices.put_mapping(index=self._name, **kwargs)

    async def get_mapping(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
        ...
        """
        return await self._get_connection(using).indices.get_mapping(index=self._name, **kwargs)
    ...
    async def get_field_mapping(
        ...
        """
        return await self._get_connection(using).indices.get_field_mapping(index=self._name, **kwargs)

    async def put_alias(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def exists_alias(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> bool:
        """
        ...
        """
        return bool(await self._get_connection(using).indices.exists_alias(index=self._name, **kwargs))

    async def get_alias(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def delete_alias(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
        ...
        """
        return await self._get_connection(using).indices.delete_alias(index=self._name, **kwargs)

    async def get_settings(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
        ...
        """
        return await self._get_connection(using).indices.get_settings(index=self._name, **kwargs)

    async def put_settings(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
        ...
        """
        return await self._get_connection(using).indices.put_settings(index=self._name, **kwargs)

    async def stats(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def segments(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def validate_query(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
        ...
        """
        return await self._get_connection(using).indices.validate_query(index=self._name, **kwargs)

    async def clear_cache(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
        ...
        """
        return await self._get_connection(using).indices.clear_cache(index=self._name, **kwargs)

    async def recovery(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
    ...
    async def shard_stores(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
        ...
        """
        return await self._get_connection(using).indices.shard_stores(index=self._name, **kwargs)

    async def forcemerge(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
        ...
        """
        return await self._get_connection(using).indices.forcemerge(index=self._name, **kwargs)

    async def shrink(self, using: Optional[AsyncUsingType] = None, **kwargs: Any) -> "ObjectApiResponse[Any]":
        """
