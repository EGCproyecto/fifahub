    ...
    def create_from(
        ...
        *,
        ...
        if create_from is None and body is None:
            raise ValueError("Empty value passed for parameters 'create_from' and 'body', one of them should be set.")
    ...
    def migrate_reindex(
        ...
        *,
        ...
        if reindex is None and body is None:
            raise ValueError("Empty value passed for parameters 'reindex' and 'body', one of them should be set.")
