...
import seleniumwire.thirdparty.mitmproxy.net.tcp
from OpenSSL import SSL
from seleniumwire.thirdparty.mitmproxy import exceptions, flow, tcp
    ...
    def __call__(self):
        ...
        try:
            while not self.channel.should_exit.is_set():
                r = seleniumwire.thirdparty.mitmproxy.net.tcp.ssl_read_select(conns, 10)
                for conn in r:
